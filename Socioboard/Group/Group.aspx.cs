            ...
            try
            {
                ...
                //{                   
                    ...
                    try
                    {
                        ...
                        {
                            //objLinkedinAccount = (LinkedInAccount)item;
                            ...
                            //objLinkedinAccount = (SocioBoard.Domain.LinkedInAccount)item;
                            ...
                            else
                            {
                                ...
                                {
                                    leftsidedata += "<li><a gid=\"" + item1.id + "\" onclick=\"linkedingroupdetails('" + item1.id + "','" + item.LinkedinUserId + "');\" linkedInUserId=\"" + item.LinkedinUserId + "\" href=\"#\">" + item1.GroupName + "</a> </li>";
                                }
                            }
