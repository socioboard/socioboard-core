        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Session["facebooktotalprofiles"] = null;
                 ...
                 //TwitterMessageRepository objaaa=new TwitterMessageRepository ();
                // List<TwitterMessage> asdasd = objaaa.getAllReadMessagesOfUser(user.Id, "1904022331,1904022338");
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('This Profile is Already Added please add another Account!');", true);
                        Session["alreadyexist"] = null;
                    }
                      if ( Session["alreadypageexist"] != null)
                    {
                        //ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('This Page is Already Added please add another Page!');", true);
