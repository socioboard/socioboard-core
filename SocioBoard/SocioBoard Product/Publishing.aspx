        ...
        <div id="top-nav">
            <div id="infocontainer">
                ...
                <div id="msgcontainer">
                    ...
                    <div class="uparrow">
                        <a href="">
                            <img src="../Contents/img/admin/uparrow.png" id="textImg1" alt="" width="33" /></a></div>
                </div>
...
/>
                                        ...
                                        <li><a href="../Default.aspx?type=logout" class="woo_logout" style="text-decoration: none;
                                            color: #767676;">
                ...
                <div id="cmposecontainer">
                    <div id="composecontent" class="composecontent">
                        <a href="#">
                            <img src="../Contents/img/admin/111.png" width="20" title="Compose" /></a>
                    </div>
                </div>
                <div id="cmposecontainer">
                    <div id="searchcontent">
                        <a href="#">
                            <img src="../Contents/img/admin/061.png" width="20" title="Search contact" /></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="rounder" id="publishing-dropdown-details">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6" id="rightspan">
                                ...
                                <div class="sub_tabs">
                                    <div onclick="ScheduleMessage();" class="btn btnk span5">
                                        Schedule</div>
                                    <div id="scheduleimg" style="float: right;" class="btn btnk span5" onclick="saveDrafts();">
                                        Save To Draft</div>
...
<script type="text/javascript" language="javascript">
    ...
    function Editqueue(id, sharemessage,ProfileType) {
        try {
            debugger;
            ...
            alertify.prompt("Please Enter New Message", function (e, str) {
                ...
                if (e) {
                    ...
                    //                    }
                    else if (parseInt(str.length) > 140 && ProfileType == "twitter") {
                        alert('Message length must should not be greater than 140 character!');
                        EditSchedulemessage(id, str);
                    }
                    else if (parseInt(str.length) > 5000 && ProfileType == "facebook") {
                        alert('Message length must should not be greater than 5000 character!');
                        EditSchedulemessage(id, str);
                    }
