<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="Discovery.aspx.cs" Inherits="SocialSuitePro.Discovery" %>
                ...
                <div id="accordion2" class="accordion">
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a id="suuggestion" href="#collapseOne"  data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                            ...
                            <div class="smart_search">
                                ...
                                <div class="input_text_select">
                                	<asp:TextBox ID="txtSearchText" runat="server"></asp:TextBox>
                                     ...
                                     <asp:CheckBoxList ID="chk_byseach" runat="server" style="float:right;" 
                                        Width="192px">
                                        <asp:ListItem Value="By Name"></asp:ListItem>
                                        <asp:ListItem Value="By Keyword"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </div>
