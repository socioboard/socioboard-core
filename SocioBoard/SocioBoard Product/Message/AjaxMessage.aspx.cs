                ...
                foreach (DataRow row in sortedDT.Rows)
                {
                    if (row["Network"].ToString() == "twitter")
                    {
                        try
                        {
                            ...
                            message += "<div id=\"messagetaskable_" + sorteddatacount + "\" class=\"userpictiny\"><div style=\"width:60px;height:60px;float:left\"><a href=\"#\" class=\"tooltip\"><img id=\"formprofileurl_" + sorteddatacount + "\" onclick=\"detailsdiscoverytwitter(this.alt);\" src=\"" + row["FromProfileUrl"] + "\" height=\"48\" width=\"48\" alt=\"" + row["FromId"] + "\" title=\"" + row["FromName"] + "\" />" +
                                                   "<img class=\"userurlpic\"  src=\"../Contents/img/twticon.png\" width=\"16\" height=\"16\" alt=\"\"><span>dasdasdsa</span></a></div><span id=\"network_" + sorteddatacount + "\" style=\"display:none;\">twitter</span>" +
                    ...
                    else if (row["Network"].ToString() == "facebook")
                    {
                        ...
                        try
                        {
                            ...
                            message += "<div id=\"messagetaskable_" + sorteddatacount + "\" class=\"userpictiny\"><div style=\"width:60px;height:60px;float:left\"><a href=\"#\" class=\"tooltip\" ><img id=\"formprofileurl_" + sorteddatacount + "\" onclick=\"getFacebookProfiles(this.alt);\" src=\"" + row["FromProfileUrl"] + "\" height=\"48\" width=\"48\" alt=\"" + row["FromId"] + "\" title=\"" + row["FromName"] + "\" />" +
                                                       "<img class=\"userurlpic\" src=\"../Contents/img/fb_icon.png\" width=\"16\" height=\"16\" alt=\"\"><span>dasdasdsa</span></a></div>" + 
                            "</div><div id=\"messagedescription_" + sorteddatacount + "\" class=\"message-list-content\"><div  id=\"msgdescription_" + sorteddatacount + "\" style=\"width:500px;height:auto;float:left\"><p>";
                    ...
                    else if (row["Network"].ToString() == "googleplus")
                    {
                        try
                        {
                            ...
                            message += "<div id=\"messagetaskable_" + sorteddatacount + "\" class=\"userpictiny\"><div style=\"width:60px;height:60px;float:left\"><a href=\"#\" class=\"tooltip\"><img id=\"formprofileurl_" + sorteddatacount + "\" onclick=\"detailsprofile(this.alt);\" src=\"" + row["FromProfileUrl"] + "\" height=\"48\" width=\"48\" alt=\"" + row["FromName"] + "\" title=\"" + row["FromName"] + "\" />" +
                                            "<img class=\"userurlpic\" src=\"../Contents/img/google_plus.png\" width=\"16\" height=\"16\" alt=\"\"><span>dasdasdsa</span></a></div>" +
                                            "</div><div id=\"messagedescription_" + sorteddatacount + "\" class=\"message-list-content\"><div  id=\"msgdescription_" + sorteddatacount + "\" style=\"width:500px;height:auto;float:left\"><p>";
