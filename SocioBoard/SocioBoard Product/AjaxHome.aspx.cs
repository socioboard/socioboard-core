            ...
            if (!string.IsNullOrEmpty(Request.QueryString["op"]))
            {
                            ...
                            foreach (SocialProfile item in alst)
                            {
                                ...
                                else if (item.ProfileType == "twitter")
                                {
                                    ...
                                    midsnaps += "<div id=\"mid_" + item.ProfileId + "\" style=\"height:213px;\" class=\"span4 rounder recpro\"><div class=\"concotop\">" +
                                     ...
                                     "<div onclick=\"detailsdiscoverytwitter('" + twtaccount.TwitterScreenName + "');\" class=\"useraccname\">" +getsortpofilename( twtaccount.TwitterScreenName) + "</div><div class=\"usercounter\">" +
                        ...
                        try
                        {
                            ...
                            if (delacc > 0)
                            {
                                ...
                                if (lstsocioprofile.Count >= 0)
                                {
                                    ...
                                    FacebookInsightStatsRepository fbInsightStats = new FacebookInsightStatsRepository();
                                    fbInsightStats.deleteFacebookInsightStats(profileid, user.Id);
                                }
                                else
                                {
                                    FacebookMessageRepository fbmsgrepo = new FacebookMessageRepository();
                    ...
                    foreach (var item in userid)
                    {
                        ...
                        if (networkingwithid[0] == "fb")
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                objFacebookAccount.FbUserId=networkingwithid[1];
                                ...
                                if(errormsg.Contains("access token"))
                                {
                                    ...
                                    objSocialProfile.ProfileId = networkingwithid[1];
                ...
                else if (Request.QueryString["op"] == "insight")
                {
                    ...
                    else
                    {
                        ...
                        Response.Write("<script>alert(\"This Page is Already Added please add another Page!\");</script>");
                    }
                            ...
                            {
                                {
                                    schmessages += "<section class=\"section\"><div  class=\"js-task-cont read\">" +
                                                             ...
                                                             "<section class=\"task-activity third\">" +
                                                                 ...
                                                                 "<p></p>" +
                                                           "</section>" +
                                                           "<section class=\"task-message font-13 third\" style=\"height: auto; width: 20%; margin-right: 9px;\"><a id=\"edit_" + item.Id + "\" onclick=\"Editqueue('" + item.Id + "','" + item.ShareMessage + "','" + item.ProfileType + "');\" class=\"tip_left\">" + gethtmlfromstring(item.ShareMessage) + "</a></section>";
                                    ...
                                    schmessages += "<section class=\"task-status\" style=\"width:34px;\"><div class=\"ui_light floating task_status_change\">" +
                                        //"<a href=\"#nogo\" class=\"ui-sproutmenu\"><span class=\"ui-sproutmenu-status\"><img title=\"Edit Status\" onclick=\"PerformClick(this.id)\" src=\"../Contents/img/icon_edit.png\" class=\"edit_button\" id=\"img_" + item.Id + "_" + item.Status + "\"></span></a></div></section>" +
                                                   ...
                                                   "<section class=\"task-status\" style=\"width: 150px; margin-right: 45px;\">" +
                                              ...
                                              "</section>" +
                                               ...
                                               "<section class=\"task-status\" style=\"width: 65px; margin-right: 39px;\">" +
                                                  "<div class=\"ui_light floating task_status_change\">" +
                                                           "<span  class=\"ui-sproutmenu-status\"><img title=\"Delete\" onclick=\"deletequeue(this.id)\" style=\"width:33px;cursor:pointer;margin-left:60px;margin-top:-10px;\" img src=\"../Contents/img/deleteimage.png\" img id=\"" + item.Id + "\"></span>" +
                                                  "</div>" +
                                              "</section>" +
