    ...
    public partial class ProfileDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    strUser += "<tr class=\"gradeX\"><td><a href=\"EditProfileDetail.aspx?id=" + item.TwitterUserId + "&type=twt&userid=" + item.UserId + "\">Edit</a></td><td>" + item.TwitterName + "</td><td>Twitter</td><td>" + item.FollowersCount + "</td><td class=\"center\">" + item.IsActive + "</td></tr>";
                }
