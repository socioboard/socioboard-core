<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="BusinessSetting.aspx.cs" Inherits="blackSheep.Settings.BusinessSetting" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<title>blackSheep-TeamMember-PersonalSetting</title>
    ...
    <script src="../Contents/js/jquery.bpopup.min.js" type="text/javascript"></script>
</asp:Content>
        ...
        <div class="ws_tm_mid">                    	
                        <div class="ws_tm_personal_setting">
                           ...
                           <div class="personal_setting_left">
                                ...
                                <div class="ws_ps_user_content">                                	
                                    <div class="personal_details">
                                    	blackSheep alerts you & your team members via email on various activities.
                                    </div>
                                    <div class="radio_content">
                              ...
                              <%--  <div class="invite_friends">Facebook Audience Confirmation</div>
                                ...
                                <div class="ws_ps_user_content">                                	
                                    <div class="personal_details">
                                        ...
                                        dedicated album titled blackSheep Photos. You are able to rename the blackSheep album within Facebook.
                                    </div>
                                    <div class="radio_content">
                                            <asp:RadioButton ID="rbFbTimeLine" runat="server" Text="Enable" 
                                                GroupName="D" />                                             
                                            <asp:RadioButton ID="rbFbblackSheepPhotos" runat="server" Text="Disabled" 
                                                GroupName="D" />  
                                </div>
