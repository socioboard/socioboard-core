<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true"
    CodeFile="Discovery.aspx.cs" Inherits="blackSheep.Discovery" %>
                    ...
                    <div class="accordion-group">
                        ...
                        <div class="accordion-body collapse" id="collapseOne">
                            <div class="accordion-inner">
                                ...
                                <%--    <li><a onclick="GetTwitterSuggestions();" ><i  class="show icon-caret-right" style="visibility: visible; margin-right: 5px"></i>blackSheep Suggestions</a>--%>
            ...
            <div id="contentcontainer1-message">
             ...
             <%--   <div id="right-sidebar">
                    <h3>
                        Suggesstions</h3>
                    <p>
                        Find new people to follow or cleanup your twitter account using blackSheep's
                        Suggestions.</p>
                    <span>Filter By</span>
                    <form name="" action="#">
