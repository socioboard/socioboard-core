<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="Publishing.aspx.cs" Inherits="blackSheep.Publishing" %>
    ...
    <div id="header">
        <div id="top-nav">
            <div class="container">
                <div id="logo">
                    <a href="">
                        <img src="../Contents/img/admin/logo.png" alt="blackSheep" /></a>
                </div>
                <div id="infocontainer" style="width: 880px;">
                    <div id="msgcontainer">
                        <div id="msgcontent">
