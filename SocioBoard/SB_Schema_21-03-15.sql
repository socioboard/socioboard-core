...
-- Dumping structure for table abhay4.admin
...
-- Dumping structure for table abhay4.ads
...
-- Dumping structure for table abhay4.affiliates
...
-- Dumping structure for table abhay4.archivemessage
...
-- Dumping structure for table abhay4.blog_comments
...
-- Dumping structure for table abhay4.blog_posts
...
-- Dumping structure for table abhay4.businesssetting
...
-- Dumping structure for table abhay4.coupon
...
-- Dumping structure for table abhay4.discoverysearch
...
-- Dumping structure for table abhay4.drafts
...
-- Dumping structure for table abhay4.facebookaccount
...
-- Dumping structure for table abhay4.facebookfeed
...
-- Dumping structure for table abhay4.facebookgroup
...
-- Dumping structure for table abhay4.facebookinsightpoststats
...
-- Dumping structure for table abhay4.facebookinsightstats
...
-- Dumping structure for table abhay4.facebookmessage
...
-- Dumping structure for table abhay4.facebookstats
...
-- Dumping structure for table abhay4.fbpagecomment
...
-- Dumping structure for table abhay4.fbpageliker
...
-- Dumping structure for table abhay4.fbpagepost
...
-- Dumping structure for table abhay4.fbpagepostcommentliker
...
-- Dumping structure for table abhay4.fbpagesharer
...
-- Dumping structure for table abhay4.feedsentimentalanalysis
...
-- Dumping structure for table abhay4.googleanalyticsaccount
...
-- Dumping structure for table abhay4.googleanalyticsstats
...
-- Dumping structure for table abhay4.googleplusaccount
...
-- Dumping structure for table abhay4.googleplusactivities
...
-- Dumping structure for table abhay4.groupprofile
...
-- Dumping structure for table abhay4.groups
...
-- Dumping structure for table abhay4.groupschedulemessage
...
-- Dumping structure for table abhay4.instagramaccount
...
-- Dumping structure for table abhay4.instagramcomment
...
-- Dumping structure for table abhay4.instagramfeed
...
-- Dumping structure for table abhay4.invitation
...
-- Dumping structure for table abhay4.linkedinaccount
...
-- Dumping structure for table abhay4.linkedincompanypage
...
-- Dumping structure for table abhay4.linkedincompanypageposts
...
-- Dumping structure for table abhay4.linkedinfeed
...
-- Dumping structure for table abhay4.linkedinmessage
...
-- Dumping structure for table abhay4.log
...
-- Dumping structure for table abhay4.loginlogs
...
-- Dumping structure for table abhay4.mandrillaccount
...
-- Dumping structure for table abhay4.news
...
-- Dumping structure for table abhay4.newsletter
...
-- Dumping structure for table abhay4.paymenttransaction
...
-- Dumping structure for table abhay4.replymessage
...
-- Dumping structure for table abhay4.rssfeeds
...
-- Dumping structure for table abhay4.rssreader
...
-- Dumping structure for table abhay4.scheduledmessage
...
-- Dumping structure for table abhay4.scheduledmessage_glbseo
CREATE TABLE IF NOT EXISTS `scheduledmessage_glbseo` (
  `Id` binary(16) NOT NULL,
  `ShareMessage` varchar(350) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Status` tinyint(1) DEFAULT NULL COMMENT 'by default 0 and after success 1 & 2 when in Process',
  `ProfileType` varchar(350) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ProfileId` varchar(350) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccessToken` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- Dumping structure for table abhay4.searchkeyword
...
-- Dumping structure for table abhay4.socialprofile
...
-- Dumping structure for table abhay4.taskcomment
...
-- Dumping structure for table abhay4.tasks
...
-- Dumping structure for table abhay4.team
...
-- Dumping structure for table abhay4.teammemberprofile
CREATE TABLE IF NOT EXISTS `teammemberprofile` (
  ...
  `ProfileName` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- Dumping structure for table abhay4.ticketassigneestatus
...
-- Dumping structure for table abhay4.tumblraccount
...
-- Dumping structure for table abhay4.tumblrfeed
...
-- Dumping structure for table abhay4.twitteraccount
...
-- Dumping structure for table abhay4.twitterdirectmessages
...
-- Dumping structure for table abhay4.twitterfeed
...
-- Dumping structure for table abhay4.twittermessage
...
-- Dumping structure for table abhay4.twitterstats
...
-- Dumping structure for table abhay4.user
...
-- Dumping structure for table abhay4.useractivation
...
-- Dumping structure for table abhay4.usergroup
...
-- Dumping structure for table abhay4.userpackagerelation
...
-- Dumping structure for table abhay4.userrefrelation
...
-- Dumping structure for table abhay4.wordpressaccount
...
-- Dumping structure for table abhay4.wordpressfeeds
...
-- Dumping structure for table abhay4.wordpresssites
...
-- Dumping structure for table abhay4.youtubeaccount
...
-- Dumping structure for table abhay4.youtubechannel
...
-- Dumping structure for table abhay4.youtubesubscription
