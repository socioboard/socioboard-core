                    ...
                    if (Session["UserAndGroupsForFacebook"] != null)
                    {
                        if (Session["UserAndGroupsForFacebook"].ToString() == "facebook")
                        {
                            try
                            {
                                ...
                                Response.Redirect("/Settings/UserGroups.aspx");
                            }
                            catch (Exception ex)
                            {
                    ...
                    else if (Session["login"] != null)
                    {
                        if (Session["login"].ToString() == "facebook")
                        {
                            ...
                            if (!string.IsNullOrEmpty(user.Password))
                            {
                                ...
                                Response.Redirect("http://localhost:5332/Default.aspx");
                               // Response.Redirect(host + "/Home.aspx");
                            }
                            else
                            {
                                Response.Redirect("SocialNetworkLogin.aspx");
                            }
                        }
