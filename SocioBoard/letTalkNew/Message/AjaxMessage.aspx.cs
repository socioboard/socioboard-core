...
namespace letTalkNew.Message
{
    public partial class AjaxMessage : System.Web.UI.Page
    {
        ...
        void ProcessRequest()
        {
            ...
            if (Request.QueryString["op"] != null)
            {
                if (Request.QueryString["op"] == "bindMessages")
                {
                    ...
                    string message = this.BindNewData(ds.Tables[0]);
                ...
                else if (Request.QueryString["op"] == "bindProfiles")
                {
                    ...
                    foreach (FacebookAccount item in alstfacebookprofiles)
                    {
                        try
                        {
                            ...
                            profiles += "<li onclick=\"checkprofile('" + item.FbUserId + "','message','facebook');\"><img src=\"../Contents/img/fbicon_new.png\"><a href=\"#\">" + item.FbUserName + "</a></li>";
                    ...
                    foreach (TwitterAccount item in alsttwt)
                    {
                        try
                        {
                            profiles += "<li onclick=\"checkprofile('" + item.TwitterUserId + "','message','twitter');\"><img src=\"../Contents/img/twittericon_new.png\"><a href=\"#\">" + item.TwitterScreenName + "</a></li>";
                    ...
                    foreach (GooglePlusAccount item in alstgp)
                    {
                        try
                        {
                            profiles += "<li onclick=\"checkprofile('" + item.GpUserId + "','message','googleplus');\"><img style=\"height:20px;width:20px;\" src=\"../Contents/img/g+new.png\"><a href=\"#\">" + item.GpUserName + "</a></li>";
                ...
                else if (Request.QueryString["op"] == "bindtasks")
                {
                    ...
                    foreach (Tasks item in taskdata)
                    {
                        try
                        {
                            ...
                            message += "<div class=\"message_list\">" +
                              "<span class=\"message_list_img\">" +
                                  "<img id=\"formprofileurl_" + sorteddatacount + "\" src=\"../Contents/img/blank_img.png\" alt=\"\">" +
                                //      "<a id=\"message_list_img_soci\" href=\"#\"><img style=\"height:18px;width:18px;\" src=\"../Contents/img/twitter.jpg\"></a>" +
                              "</span>" +
                              "<ul class=\"message_list_right\">" +
                                  "<span id=\"createdtime_" + sorteddatacount + "\">" + item.AssignDate + "</span>" +
                                  "<a id=\"msgdescription_" + sorteddatacount + "\" href=\"#\">" + item.TaskMessage + "</a>" +
                                  "<h2 id=\"rowname_" + sorteddatacount + "\">" + user.UserName + "</h2>" +
                                  "<div class=\"msg_edit\"><a id=\"img_"+item.Id+"_"+b+"\" onclick=\"PerformClick(this.id,"+sorteddatacount+",'"+b+"')\"><img class=\"edit_button\" src=\"../Contents/img/icon_edit.png\" alt=\"\"></a></div>" +
                                  "<div id=\"status_"+sorteddatacount+"\" class=\"message_list_right_comment\">" +
                                     b +
                                  "</div>" +
                              "</ul> </div>";
                        }
                ...
                else if (Request.QueryString["op"] == "bindarchive")
                {
                    ...
                    if (result != null)
                    {
                        ...
                        "<span class=\"message_list_img\">" +
                            ...
                            "<a class=\"message_list_img_soci\" href=\"#\"><img style=\"height:18px;width:18px;\" src=\"../Contents/img/twitter.jpg\"></a>" +
                        "</span>" +
                        "<ul class=\"message_list_right\">" +
                            "<span>" + item.CreatedDateTime + "</span>" +
                            "<a href=\"#\">" + item.Message + "</a>" +
                               "<h2>" + item.UserName + "</h2>" +
                            "<div class=\"message_list_right_comment\">" +
                       ...
                       "<span class=\"message_list_img\">" +
                           "<img src=\"" + item.ImgUrl + "\" alt=\"\">" +
                           "<a class=\"message_list_img_soci\" href=\"#\"><img style=\"height:18px;width:18px;\" src=\"../Contents/img/fb_24X24.png\"></a>" +
                       "</span>" +
                       "<ul class=\"message_list_right\">" +
                           "<span>" + item.CreatedDateTime + "</span>" +
                           "<a href=\"#\">" + item.Message + "</a>" +
                       ...
                       "</ul> </div>";
                         ...
                         "<span class=\"message_list_img\">" +
                             "<img src=\"" + item.ImgUrl + "\" alt=\"\">" +
                             "<a class=\"message_list_img_soci\" href=\"#\"><img style=\"height:18px;width:18px;\" src=\"../Contents/img/google_plus.png\"></a>" +
                         "</span>" +
                         "<ul class=\"message_list_right\">" +
                             "<span>" + item.CreatedDateTime + "</span>" +
                             "<a href=\"#\">" + item.Message + "</a>" +
            ...
            foreach (DataRow row in sortedDT.Rows)
            {
                if (row["Network"].ToString() == "twitter")
                {
                    try
                    {
                        ...
                        {
                            message += "<div id=\"message_list\" class=\"unread\">";
                        }
                        else
                        {
                            message += "<div id=\"message_list\">";
                        }

                        message += "<div id=\"messagedescription_" + sorteddatacount + "\"><span id=\"message_list_img\"><img src=\"" + row["FromProfileUrl"] + "\"><a href=\"#\" id=\"message_list_img_soci\"><img src=\"../Contents/img/twitter.jpg\" ></a></span>" +
                                  "<ul id=\"message_list_right\"><span>" + row["MessageDate"].ToString() + "</span>";
                        ...
                        message += "<h2><a href=\"#\" id=\"rowname_" + sorteddatacount + "\" onclick=\"detailsprofile('" + row["FromId"] + "');\">" + row["FromName"] + "</a></h2>" +
                                     " <div id=\"message_list_right_comment\"><a href=\"#\" id=\"savearchive_" + sorteddatacount + "\" onclick=\"savearchivemsg(" + sorteddatacount + ",'twitter','" + row["MessageId"].ToString() + "','" + row["ProfileId"].ToString() + "');\"><img id=\"msg_archieve\" src=\"../Contents/img/list_icon1.png\"></a> " +
                                     "<a href=\"#\" onclick=replyfunction(" + sorteddatacount + ",'twitter','" + row["MessageId"].ToString() + "','" + row["FromId"] + "')><img id=\"msg_reply\" src=\"../Contents/img/list_icon2.png\" ></a>" +
                                     "<a id=\"createtasktwt_" + sorteddatacount + "\" href=\"#\" onclick=\"createtask(this.id);\"><img id=\"msg_task\" src=\"../Contents/img/list_icon3.png\"></a></div></ul></div> </div>";


                        //<span><a href=\"#\" id=\"rowname_" + sorteddatacount + "\" onclick=\"detailsprofile('" + row["FromId"] + "');\">" + row["FromName"] + "</a><div id=\"createdtime_" + sorteddatacount + "\">" + row["MessageDate"].ToString() + "</div></span>" +
                        //"<div class=\"scl\">" +
                ...
                else if (row["Network"].ToString() == "facebook")
                {
                    try
                    {
                        ...
                        message += "<span id=\"message_list_img\"><img src=\"" + row["FromProfileUrl"] + "\"><a href=\"#\" id=\"message_list_img_soci\"><img src=\"../Contents/img/fb_24X24.jpg\" ></a></span>" +
                                  "<ul id=\"message_list_right\"><span>" + row["MessageDate"].ToString() + "</span>";
                        ...
                        message += " <a href=\"#\" id=\"rowname_" + sorteddatacount + "\" onclick=\"detailsprofile('" + row["FromId"] + "');\">" + row["FromName"] + "</a><h2></h2>" +
                                     " <div id=\"message_list_right_comment\"><a href=\"#\" id=\"savearchive_" + sorteddatacount + "\" onclick=\"savearchivemsg(" + sorteddatacount + ",'twitter','" + row["MessageId"].ToString() + "','" + row["ProfileId"].ToString() + "');\"><img src=\"../Contents/img/list_icon1.png\"></a> " +
                                     "<a href=\"downloads.html\" onclick=replyfunction(" + sorteddatacount + ",'twitter','" + row["MessageId"].ToString() + "','" + row["FromId"] + "')><img src=\"../Contents/img/list_icon2.png\" ></a>" +
                                     "<a id=\"createtasktwt_" + sorteddatacount + "\" href=\"#\" onclick=\"createtask(this.id);\"><img src=\"../Contents/img/list_icon3.png\"></a></div></ul></div>";
        ...
        public string BindNewData(DataTable dt)
        {
            string message = string.Empty;
            DataView dv = dt.DefaultView;
            dv.Sort = "ReadStatus ,MessageDate desc";
            ...
            foreach (DataRow row in sortedDT.Rows)
            {
                if (row["Network"].ToString() == "twitter")
                {
                    try
                    {
                        message += "<div class=\"message_list\">" +
                           "<span class=\"message_list_img\">" +
                               "<img id=\"formprofileurl_" + sorteddatacount + "\" src=\"" + row["FromProfileUrl"] + "\" alt=\"\">" +
                               "<a class=\"message_list_img_soci\" href=\"#\"><img style=\"height:18px;width:18px;\" src=\"../Contents/img/twitter.jpg\"></a>" +
                           "</span>" +
                           "<ul class=\"message_list_right\">" +
                               "<span id=\"createdtime_" + sorteddatacount + "\">" + row["MessageDate"].ToString() + "</span>" +
                               "<a id=\"msgdescription_" + sorteddatacount + "\" href=\"#\">" + row["Message"].ToString() + "</a>" +
                               "<h2 id=\"rowname_" + sorteddatacount + "\">" + row["FromName"] + "</h2>" +
                               "<div class=\"message_list_right_comment\">" +
                                   "<a onclick=\"replyfunction(" + sorteddatacount + ",'twitter','" + row["MessageId"].ToString() + "','" + row["FromId"] + "')\" href=\"#\"><img src=\"../Contents/img/list_icon1.png\"></a>" +
                                   "<a onclick=\"savearchivemsg(" + sorteddatacount + ",'twitter','" + row["MessageId"].ToString() + "','" + row["FromId"] + "');\" id=\"savearchive_" + sorteddatacount + "\"><img src=\"../Contents/img/list_icon2.png\"></a>" +
                                   "<a onclick=\"createtask(this.id);\" id=\"createtasktwt_" + sorteddatacount + "\"><img src=\"../Contents/img/list_icon3.png\"></a>" +
                               "</div>" +
                           "</ul> </div>";
                    }
                    catch { }
                ...
                else if (row["Network"].ToString() == "facebook")
                {
                    try
                    {
                        ...
                        "<ul class=\"message_list_right\">" +
                            ...
                            "<h2 id=\"rowname_" + sorteddatacount + "\">" + row["FromName"] + "</h2>" +
                            "<div class=\"message_list_right_comment\">" +
                                "<a onclick=\"replyfunction(" + sorteddatacount + ",'facebook','" + row["MessageId"].ToString() + "','" + row["FromId"] + "')\" href=\"#\"><img src=\"../Contents/img/list_icon1.png\"></a>" +
                                "<a onclick=\"savearchivemsg(" + sorteddatacount + ",'facebook','" + row["MessageId"].ToString() + "','" + row["FromId"] + "');\" id=\"savearchive_" + sorteddatacount + "\"><img src=\"../Contents/img/list_icon2.png\"></a>" +
                                "<a onclick=\"createtask(this.id);\" id=\"createtasktwt_" + sorteddatacount + "\"><img src=\"../Contents/img/list_icon3.png\"></a>" +
                            "</div>" +
                        "</ul> </div>";
                    }
                    ...
                    try
                    {
                      ...
                      "<span class=\"message_list_img\">" +
                        ...
                        "<ul class=\"message_list_right\">" +
                            ...
                            "<h2 id=\"rowname_" + sorteddatacount + "\">" + row["FromName"] + "</h2>" +
                           "<div class=\"message_list_right_comment\">" +
                               "<a onclick=\"replyfunction(" + sorteddatacount + ",'googleplus','" + row["MessageId"].ToString() + "','" + row["FromId"] + "')\" href=\"#\"><img src=\"../Contents/img/list_icon1.png\"></a>" +
                                "<a onclick=\"savearchivemsg(" + sorteddatacount + ",'googleplus','" + row["MessageId"].ToString() + "','" + row["FromId"] + "');\" id=\"savearchive_" + sorteddatacount + "\"><img src=\"../Contents/img/list_icon2.png\"></a>" +
                                "<a onclick=\"createtask(this.id);\" id=\"createtasktwt_" + sorteddatacount + "\"><img src=\"../Contents/img/list_icon3.png\"></a>" +
                           "</div>" +
                       "</ul> </div>";
                    }
