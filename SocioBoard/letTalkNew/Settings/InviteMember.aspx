<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Home.Master" AutoEventWireup="true" CodeBehind="InviteMember.aspx.cs" Inherits="letTalkNew.Settings.InviteMember" %>
...
<script src="../Contents/js/jquery-1.4.1.min.js" type="text/javascript"></script>
 ...
 <link rel="stylesheet" type="text/css" href="../Contents/css/Style_previous.css" />
    ...
    <div class="ws_container_page" style="width:840px;">
                 <asp:HiddenField ID="HiddenfieldProfID" runat="server" />
                    ...
                    <div class="ws_tm_mid">
                    	<div class="invite_friends">Invite a Team Member <a href="PersonalSetting.aspx">← Back to Settings</a></div>
