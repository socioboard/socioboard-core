...
namespace letTalkNew
{
    public partial class Discovery : System.Web.UI.Page
    {
        ...
        public string BindData(DiscoverySearch dissearch, int i)
        {
            ...
            {
                message += "<li><div class=\"userpictiny\" id=\"messagetaskable_" + i + "\"><div>" +
                            "<img width=\"100\" height=\"100\" title=\"" + dissearch.FromName + "\" alt=\"" + dissearch.FromName + "\" src=\"" + dissearch.ProfileImageUrl + "\" onclick=\"detailsprofile(this.alt);\" id=\"formprofileurl_" + i + "\"><a title=\"\" class=\"userurlpic\" href=\"#\"><img width=\"16\" height=\"16\" alt=\"\" src=\"../Contents/img/fb_icon.png\">" +
            ...
            {
                message += "<li><div class=\"userpictiny\" id=\"messagetaskable_" + i + "\"><div>" +
                            "<img width=\"100\" height=\"100\" title=\"" + dissearch.FromName + "\" alt=\"" + dissearch.FromName + "\" src=\"" + dissearch.ProfileImageUrl + "\" onclick=\"detailsprofile(this.alt);\" id=\"formprofileurl_" + i + "\"><a title=\"\" class=\"userurlpic\" href=\"#\"><img width=\"16\" height=\"16\" alt=\"\" src=\"../Contents/img/twticon.png\">" +
                            "</a></div></div><div class=\"message-list-content\" id=\"messagedescription_" + i + "\">" +
                            "<div style=\"width:500px;height:auto;float:left\"><p>" + dissearch.Message + "</p>" +
                            "<div class=\"message-list-info\"><span><a onclick=\"detailsprofile(this.id);\" id=\"rowname_" + i + "\" href=\"#\">" + dissearch.FromName + "</a> " + dissearch.CreatedTime + "</span>" +
                            "</div></div></div></li>";
