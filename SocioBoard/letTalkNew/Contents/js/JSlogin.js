...
//    }
//    else {
//        $("#RequiredFieldValidator5").html("Please Enter valid Name");
//        $("#RequiredFieldValidator5").show();
//        return false;
//    }
//}
...
function signinFunction() {
    ...
    try {
        ...
        $(".loader").html("<img src='../Contents/img/282.gif' alt=''/>");
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        if (msg == "user") {
                            ...
                            $(".loader").html("<input name=\"ctl01\" type=\"button\" value=\"Submit\" onclick=\"signinFunction();\">");
