        ...
        public void ProcessRequest()
        {
            if (!string.IsNullOrEmpty(Request.QueryString["op"]))
            {
                ...
                else if (Request.QueryString["op"] == "facebookwallposts")
                {
                    ...
                    foreach (FacebookMessage item in lsgfbmsgs)
                    {
                        try
                        {
                            ...
                            messages += "<li><span><img src=\"" + item.FromProfileUrl + "\" alt=\"\" /></span>" +
                            "<h2>" + item.FromName + "</h2>" +
                            "<p>" + item.Message + "</p>" +
                            "<a >"+ item.MessageDate + "</a>" +
                        "</li>";
                            ...
                            //}
                            //messages+= item.MessageDate+ "</span><h2>" + item.FromName + "</h2><p> ";
                            ...
                            //    }
                            //}
                            //  messages +="</p><a href=\"#\">anagha5:30:15 PM</a></li>";
                    ...
                    if (network == "facebook")
                    {
                        ...
                        if (lstschmsg.Count != 0)
                        {
                            foreach (ScheduledMessage item in lstschmsg)
                            {
                                ...
                                try
                                {
                                    message += "<li><div class=\"feedim pull-left\"><img alt=\"\"  src=\"../Contents/img/blank_img.png\">" +
                                                                 "</div><div class=\"pull-left feedcontent\">" +
                ...
                else if (Request.QueryString["op"] == "facebookfeeds")
                {
                    ...
                    {
                        #region oldone
                        //message += "<li><div class=\"feedim pull-left\"><img alt=\"\" width=\"31\" height=\"31\" src=\"http://graph.facebook.com/" + item.ProfileId + "/picture?type=small\" onclick=\"getFacebookProfiles('" + item.FromId + "');\">" +
                        //                                         "</div><div class=\"pull-left feedcontent\">" +
                        ...
                        message += "<li>"+
                        	"<span><img src=\""+item.FromProfileUrl+"\" alt=\"\" /></span>"+
                            "<h2>"+item.FromName+"</h2>"+
                            "<b></b>"+
                            "<a>"+item.FeedDate+"</a>"+
                    ...
                    try
                    {
                        ...
                        if (lstInsFeed.Count != 0)
                        {
                            ...
                            foreach (InstagramFeed feed in lstInsFeed)
                            {
                                try
                                {
                                    strInsImage += "<div class=\"grid\" class=\"row-fluid\"><div class=\"box whitebg feedwrap\"><div class=\"topicon\"><div class=\"pull-left\">" +
                                                                    ...
                                                                    "<img width=\"12\" alt=\"\" src=\"../Contents/img/admin/heart-empty.png\"> " + feed.LikeCount + "</span><span class=\"pull-left span3\"><img width=\"12\" alt=\"\" src=\"../Contents/img/admin/speech-bubble-left.png\"> 37</span><div class=\"clearfix\"></div>";
                ...
                else if (Request.QueryString["op"] == "instagramuserpopup")
                {
                    try
                    {
                        InstagramAccountRepository insaccrepo = new InstagramAccountRepository();
                        ArrayList alstinstagram = insaccrepo.getAllInstagramAccountsOfUser(user.Id);
                        string struser = JsonConvert.SerializeObject(alstinstagram);
                        //foreach (InstagramAccount item in alstinstagram)
                        //{
                        //    struser += "<li><a id=\"liins_" + item.InstagramId + "\" href=\"#\" onclick=\"Instagramdetails('" + item.AccessToken + "','" + item.InstagramId + "','like');\" class=\"active\">" + item.InsUserName + "</a> </li>";
                        //}
