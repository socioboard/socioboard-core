...
CREATE TABLE IF NOT EXISTS `facebookmessage` (
  ...
  `Type` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `UserId` binary(16) DEFAULT NULL,
  `Picture` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `invitation` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `SenderEmail_FriendEmail` (`SenderEmail`(255),`FriendEmail`(255))
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `rssreader` (
  `Id` binary(16) NOT NULL,
  `Title` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `Description` text CHARACTER SET utf8,
  `CreatedDate` datetime DEFAULT NULL,
  `FeedsUrl` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `PublishedDate` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `Status` tinyint(1) DEFAULT NULL COMMENT '0 - running and 1 means not',
  `Link` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `twitterfeed` (
  ...
  `UserId` binary(16) DEFAULT NULL,
  `Type` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `ScreenName` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `MessageId` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `SourceUrl` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `InReplyToStatusUserId` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  `FromScreenName` varchar(350) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
