...
$("#selectallTwt").change(function () {
    if ($('#selectallTwt').is(':checked')) {
        ...
        var totalprofiels = document.getElementById('<%=totalaccountscheck.ClientID %>').innerHTML;
        ...
        var totalprofielss = document.getElementById('<%=totalaccountscheck.ClientID %>').innerHTML;
...
$("#selectallFb").change(function () {
    ...
    if ($('#selectallFb').is(':checked')) {
        ...
        try {
            ...
            if (chkfb.length == 0) {
                alert("No profiles for Facebook");
...
$("#selectallLd").change(function () {
    ...
    if ($('#selectallLd').is(':checked')) {
        ...
        try {
            ...
            if (chklin.length == 0) {
                alert("No profiles for Linkedin");
...
$("#selectallIns").change(function () {
    ...
    if ($('#selectallIns').is(':checked')) {
        ...
        try {
            ...
            if (chkins.length == 0) {
                alert("No profiles for Instagram");
