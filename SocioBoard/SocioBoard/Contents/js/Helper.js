...
//function detailsdiscoveryYoutube(id) {
//    try {
//        // alert(id);
//        debugger;
//        $("#another-load").html('<img src="../Contents/img/360.gif" />');
...
//        ({
//            type: "GET",
//            url: "../Helper/AjaxHelper.aspx?op=detailsdiscoveryYouTube&profileid=" + id,
//            crossDomain: true,
//            contentType: "application/json; charset=utf-8",
//            dataType: "html",
//            success: function (msg) {
...
function detailsdiscoverylnk(id) {
    try {
        // alert(id);
        debugger;
        $("#another-load").html('<img src="../Contents/img/360.gif" />');
        ...
        ({
            type: "GET",
            url: "../Helper/AjaxHelper.aspx?op=detailsdiscoverylnk&profileid=" + id,
            crossDomain: true,
            contentType: "application/json; charset=utf-8",
            dataType: "html",
            success: function (msg) {
...
function detailsdiscoveryInstagram(id) {
    try {
        // alert(id);
        debugger;
        $("#another-load").html('<img src="../Contents/img/360.gif" />');
        ...
        ({
            type: "GET",
            url: "../Helper/AjaxHelper.aspx?op=detailsdiscoveryinstagram&profileid=" + id,
            crossDomain: true,
            contentType: "application/json; charset=utf-8",
            dataType: "html",
            success: function (msg) {
