...
using System.Linq;
using System.Text;
using GlobusInstagramLib.Instagram.Core.LikesMethods;
...
namespace GlobusInstagramLib.App.Core
{
    public class LikesController
    {
        ...
        public void PostLikesArray(string[] mediaids, string accessToken)
        {
            ...
            {
                objLikes.PostLike(mediaid, null, accessToken);
            }
        }
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        public bool PostUserLike(string mediaid, string userid, string accessToken)
        {
            Likes objLikes = new Likes();
            return objLikes.PostLike(mediaid, userid, accessToken);
        }
        ...
        public void DeleteArrayLike(string[] mediaids, string accessToken)
        {
            ...
            foreach (var mediaid in mediaids)
            {
                objLikes.LikeDelete(mediaid, null, accessToken);
            }
        }
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        public bool DeleteLike(string mediaid, string userid, string accessToken)
        {
            Likes objLikes = new Likes();
            return objLikes.LikeDelete(mediaid, userid, accessToken);
        }
