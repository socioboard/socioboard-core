<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="~/Reports/FacebookReport.aspx.cs" Inherits="SocialSuitePro.Reports.FacebookReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="mainwrapper" class="container reports">
        <div id="sidebar">
            <div class="sidebar-inner">
                <a href="GroupStats.aspx" class="btn">GROUP REPORT
                    <img src="../Contents/img/admin/boxes.png" alt="" class="pull-right" /></a>
                <a href="#" class="btn actives" id="facebook_page">Facebook Pages
        ...
        <div id="contentcontainer-report">
            <div id="content" style="left: 0;">
                ...
                <div class="rounder shadower pull-left reportcontent" style="padding-right: 20px;
                    width: 895px;">
                    <div class="fb-page-profilimg">
                        <img src="../Contents/img/avathar-1.jpg" alt="" id="fbProfileImg" runat="server"></div>
                    <div class="fb-graph-right">
                        <div class="fb-graph-right-header">
                            <div class="fb-graph-right-head-left">
                                <h2 id="divPageName" runat="server">
                                    "Please add atleast one Facebook Fan Page..."</h2>
                                <br>
                                <div id="divPageLikes" runat="server">
                                </div>
                            </div>
                       ...
                       <%-- <div class="impress-age">
                            <div class="impression-head" style="margin-left: -75px;">
                                <h2>
                    ...
                    <div id="social_graph1" style="width: 515px; height: 135px;display:none">
                    </div>
                    <div class="impression-graph-outer">
                        ...
                        <div class="impres-chart">
                            <%--<div id="impress_chart" style="width: 865px; height: 175px;">
                            </div>--%>
                            <div id="impres_graph" style="width: 515px; height: 135px;">
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="stories-graph-right">
                        <div class="stories-graph-head">
                            ...
                            <%--<div class="stories-graph-right-head">
                                <img src="../Contents/img/graph-icon.jpg" alt="" align="absmiddle" />Stories Created
                                <strong>254.6k </strong><span>
                                    <img src="../Contents/img/graph-icon2.jpg" alt="" align="absmiddle" />
                                    by 127.5k Users</span>
                            </div>--%>
                            <div class="clear">
                            </div>
                        </div>
                        <div class="stories-fb-graph">
                            ...
                            <div id="Stories_Graph" style="width: 515px; height: 135px;">
                            </div>
                        </div>
                        <div class="clear">
                        </div>
                        <div class="impression-break-container">
                            <div class="share-pie-left">
                               <%-- <div class="impression-break-head">
                                    share type</div>--%>
                                <div class="share-pie-left">
                                    <div id="Div1" style="width: 410px; height: 175px;">
                                    </div>
                                </div>
                                <div class="clear">
                                </div>
                    ...
                    <div class="rounder shadower pull-left reportcontent" style="padding-right: 20px;
                        ...
                        <div class="storetype-right">
                            <div class="store-table">
                                ...
                                <div class="store-table-content">
                                    <div class="label1">
                                        People Talking About This</div>
                                    <div class="label2">
                                        <span id="spanTalking" runat="server">0</span></div>
                                    <div class="label3">
                                        <span></span>
                                    </div>
                                    <div class="clear">
                        ...
                        <div class="foot-header">
                            Content BreakDown <span>A breakdown of how your individual post performed.</span></div>
    ...
    <script src="<%= Page.ResolveUrl("~/Contents/js/reloadfbgraph.js")%>" type="text/javascript"></script>
    <%--<style>
        canvas
        {
        }
...
//        getProfilefbGraph(id, name, img, access,days);
...
//    });
	    ...
	    $(document).ready(function () {
            ...
            fbstory="<%=strstoriesArray %>".split("@");
            likeunlikedt="<%=likeunlikedate %>".split("@");
            pageimpression="<%=strPageImpression%>".split("@");
           reloadfbGraph(likeunlikedt);
           reloadimpresGraph(pageimpression);
           reloadStoriesGraph(fbstory);
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var likeunlikedt = "<%=likeunlikedate %>".split("@");
                reloadfbGraph(likeunlikedt);
                var pageimpression = "<%=strPageImpression%>".split("@");
                reloadimpresGraph(pageimpression);
                var fbstory = "<%=strstoriesArray %>".split("@");
                reloadStoriesGraph(fbstory);
