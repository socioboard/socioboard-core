...
namespace SocialSuitePro.Reports
{
    ...
    {
        ILog logger = LogManager.GetLogger(typeof(AjaxReport));
        ...
        protected void procesRequest()
        {
            ...
            if (Request.QueryString["op"] == "facebook")
            {
                ...
                Response.Write(strPageImpression + "_"  + strval + "_" + PeopleTalkingAboutThis + "_" + imgPath + "_" + strstoriesArray + "_" + fanpost);
            }
        }
