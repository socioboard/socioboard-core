...
namespace SocioBoard.Message
{
    public partial class Task : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
                //  rdbtnmytask_CheckedChanged(sender,e);
                rdbtnteamtask_CheckedChanged(sender, e);
               // bindTeamTask();
        }
        ...
        protected void bindTeamTask()
        {
            ...
            foreach (Tasks item in taskdata)
            {
                ...
                strbind += "<section class=\"section\" id=\"Section"+ item.Id +"\"><div class=\"js-task-cont read\"><section class=\"task-owner\">" +
                                   ...
                                   "</section><section class=\"task-activity third\"><p>Name</p><div>" + item.AssignDate + "</div><input type=\"hidden\" id=\"hdntaskid_" + i + "\" value=" + item.Id + " />" +
                                  "<p>Assigned by Name</p></section><section class=\"task-message font-13 third\"><a class=\"tip_left\">" + item.TaskMessage + "</a>" +
