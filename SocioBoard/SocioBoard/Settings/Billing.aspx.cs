    ...
    public partial class Billing : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                heading5.InnerHtml = lstPackage[4].PackageName.ToString();
                if (user.AccountType == lstPackage[4].PackageName.ToString())
                {
                    price5.InnerHtml = "<h3 style=\"color: #F4594F;\"> $ " + lstPackage[4].Pricing.ToString() + " Per User/Month</h3>";
                    ContentPlaceHolder1_SocioBasic.InnerHtml = "<span class=\"trail_btn active\">Current Package!</span>";
                    // ContentPlaceHolder1_premiumplan.Attributes.Add("href", "#");
                }
                else
                {
                    price5.InnerHtml = "<h3> $ " + lstPackage[4].Pricing.ToString() + " Per User/Month</h3>";
                    ContentPlaceHolder1_SocioBasic.InnerHtml = "<span class=\"trail_btn\">Upgrade</span>";
                }


                heading6.InnerHtml = lstPackage[5].PackageName.ToString();
                if (user.AccountType == lstPackage[5].PackageName.ToString())
                {
                    price6.InnerHtml = "<h3 style=\"color: #F4594F;\"> $ " + lstPackage[5].Pricing.ToString() + " Per User/Month</h3>";
                    ContentPlaceHolder1_SocioStandard.InnerHtml = "<span class=\"trail_btn active\">Current Package!</span>";
                    // ContentPlaceHolder1_premiumplan.Attributes.Add("href", "#");
                }
                else
                {
                    price6.InnerHtml = "<h3> $ " + lstPackage[5].Pricing.ToString() + " Per User/Month</h3>";
                    ContentPlaceHolder1_SocioStandard.InnerHtml = "<span class=\"trail_btn\">Upgrade</span>";
                }

                heading7.InnerHtml = lstPackage[6].PackageName.ToString();
                if (user.AccountType == lstPackage[6].PackageName.ToString())
                {
                    price7.InnerHtml = "<h3 style=\"color: #F4594F;\"> $ " + lstPackage[6].Pricing.ToString() + " Per User/Month</h3>";
                    ContentPlaceHolder1_SocioPremium.InnerHtml = "<span class=\"trail_btn active\">Current Package!</span>";
                    // ContentPlaceHolder1_premiumplan.Attributes.Add("href", "#");
                }
                else
                {
                    price7.InnerHtml = "<h3> $ " + lstPackage[6].Pricing.ToString() + " Per User/Month</h3>";
                    ContentPlaceHolder1_SocioPremium.InnerHtml = "<span class=\"trail_btn\">Upgrade</span>";
                }

                heading8.InnerHtml = lstPackage[7].PackageName.ToString();
                if (user.AccountType == lstPackage[7].PackageName.ToString())
                {
                    price8.InnerHtml = "<h3 style=\"color: #F4594F;\"> $ " + lstPackage[7].Pricing.ToString() + " Per User/Month</h3>";
                    ContentPlaceHolder1_SocioDeluxe.InnerHtml = "<span class=\"trail_btn active\">Current Package!</span>";
                    // ContentPlaceHolder1_premiumplan.Attributes.Add("href", "#");
                }
                else
                {
                    price8.InnerHtml = "<h3> $ " + lstPackage[7].Pricing.ToString() + " Per User/Month</h3>";
                    ContentPlaceHolder1_SocioDeluxe.InnerHtml = "<span class=\"trail_btn\">Upgrade</span>";
                }


                if (type == "Standard" || type == "Premium" || type == "Deluxe" || type == "SocioBasic" || type == "SocioPremium" || type == "SocioStandard" || type == "SocioDeluxe")
                {
                    Payment();
                }
            }
