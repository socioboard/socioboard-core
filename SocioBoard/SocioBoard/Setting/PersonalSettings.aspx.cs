...
namespace SocioBoard.Setting
{
    public partial class PersonalSettings : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string path = Server.MapPath("~/Contents/Images/user_img/" +imgfileupload.FileName);
                imgfileupload.SaveAs(path);
                user.ProfileUrl = imgfileupload.FileName;
            }
            user.UserName = txtFirstName.Text + " " + txtLastName.Text;
            user.TimeZone = ddlTimeZone.SelectedItem.Text;
