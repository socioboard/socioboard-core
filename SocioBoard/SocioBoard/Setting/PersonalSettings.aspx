<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="PersonalSettings.aspx.cs" Inherits="SocioBoard.Setting.PersonalSettings" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>WooSuite-TeamMember-PersonalSetting</title>
    <link rel="stylesheet" type="text/css" href="../Contents/Styles/Style.css" />
    <link href="../Contents/Scripts/uploadify.css" rel="stylesheet" type="text/css" />
   
  

    <script src="../Contents/Scripts/jquery.uploadify-3.1.js" type="text/javascript"></script>
    ...
    <div class="ws_container_page">
        ...
        <div class="ws_tm_mid">
            <div class="ws_tm_personal_setting">
                ...
                <div class="personal_setting_right">
                    ...
                    <div class="addsocial_network">
                        <div class="addNetworkIcon">
                            <a>+ <span class="social_icon">
                                <img src="../Contents/Images/twiter_24X24.png" width="16" height="15" alt="" /></span></a>
                        </div>
                    ...
                    <div class="addsocial_network">
                        <div class="addNetworkIcon">
                            <a id="facebookanchor" runat="server">+ <span class="social_icon">
                                <img src="../Contents/Images/fb_24X24.png" width="16" height="15" alt="" /></span></a>
                        </div>
                        <div class="add_to_netword">
                    ...
                    <div class="addsocial_network">
                        <div class="addNetworkIcon">
                            <a id="linkinanchor" runat="server">+ <span class="social_icon">
                                <img src="../Contents/Images/linked_25X24.png" width="16" height="15" alt="" /></span></a>
                        </div>
                        <div class="add_to_netword">
                    ...
                    <div class="addsocial_network">
                        <div class="addNetworkIcon">
                            <a id="GoogleAnalyticsanchor" runat="server">+ <span class="social_icon">
                                <img src="../Contents/Images/an_24X24.png" width="16" height="15" alt="" /></span></a>
                        </div>
                        <div class="add_to_netword">
                    ...
                    <div class="addsocial_network">
                        <div class="addNetworkIcon">
                            <a id="googleplusanchor" runat="server">+ <span class="social_icon">
                                <img src="../Contents/Images/google_plus.png" width="16" height="15" alt="" /></span></a>
                        </div>
                        <div class="add_to_netword">
                    ...
                    <div class="addsocial_network">
                        <div class="addNetworkIcon">
                            <a>+ <span class="social_icon">
                                <img src="../Contents/Images/instagram_24X24.png" width="16" height="15" alt="" /></span></a>
                        </div>
                        <div class="add_to_netword">
            ...
            <div class="ws_tm_button_div">
                <asp:Button ID="btnSave" runat="server" Text="Save"  ValidationGroup="setting" 
