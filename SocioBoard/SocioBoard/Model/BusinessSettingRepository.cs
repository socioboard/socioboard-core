...
namespace SocioBoard.Model
{
    ...
    public class BusinessSettingRepository : IBusinessSettingRepository
    {
        ...
        public void AddBusinessSetting(BusinessSetting businessSetting)
        {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<BusinessSetting> lstBusinessSetting = CheckUserId(businessSetting.UserId,businessSetting.GroupId,businessSetting.BusinessName);
        ...
        public List<BusinessSetting> CheckUserId(Guid UserId, Guid GroupId,string GroupName)
        {
        ...
        public BusinessSetting IsNotificationTaskEnable(Guid groupId)
        {
            // bool flag = 0;
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
