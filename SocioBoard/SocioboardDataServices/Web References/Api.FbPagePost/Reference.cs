...
namespace SocioboardDataServices.Api.FbPagePost {
    ...
    public partial class FbPagePost : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public bool AddPostDetails(string JsonObjectOfFbPagePostWithValue) {
            object[] results = this.Invoke("AddPostDetails", new object[] {
                        JsonObjectOfFbPagePostWithValue});
            return ((bool)(results[0]));
        }
        
        /// <remarks/>
        public void AddPostDetailsAsync(string JsonObjectOfFbPagePostWithValue) {
            this.AddPostDetailsAsync(JsonObjectOfFbPagePostWithValue, null);
        }
        
        /// <remarks/>
        public void AddPostDetailsAsync(string JsonObjectOfFbPagePostWithValue, object userState) {
            ...
            this.InvokeAsync("AddPostDetails", new object[] {
                        JsonObjectOfFbPagePostWithValue}, this.AddPostDetailsOperationCompleted, userState);
        }
        ...
        public bool IsPostExist(string JsonObjectOfFbPagePostWithValue) {
        ...
        /// <remarks/>
        public void IsPostExistAsync(string JsonObjectOfFbPagePostWithValue) {
            this.IsPostExistAsync(JsonObjectOfFbPagePostWithValue, null);
        }
        
        /// <remarks/>
        public void IsPostExistAsync(string JsonObjectOfFbPagePostWithValue, object userState) {
            ...
            this.InvokeAsync("IsPostExist", new object[] {
                        JsonObjectOfFbPagePostWithValue}, this.IsPostExistOperationCompleted, userState);
        }
        ...
        public int UpdateFbPagePostStatus(string JsonObjectOfFbPagePostWithValue) {
        ...
        /// <remarks/>
        public void UpdateFbPagePostStatusAsync(string JsonObjectOfFbPagePostWithValue) {
            this.UpdateFbPagePostStatusAsync(JsonObjectOfFbPagePostWithValue, null);
        }
        
        /// <remarks/>
        public void UpdateFbPagePostStatusAsync(string JsonObjectOfFbPagePostWithValue, object userState) {
            ...
            this.InvokeAsync("UpdateFbPagePostStatus", new object[] {
                        JsonObjectOfFbPagePostWithValue}, this.UpdateFbPagePostStatusOperationCompleted, userState);
        }
