...
namespace SocioboardDataServices.Api.FbPageComment {
    ...
    public partial class FbPageComment : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public bool AddCommentDetails(string JsonObjectOfFbPageCommentWithValue) {
            object[] results = this.Invoke("AddCommentDetails", new object[] {
                        JsonObjectOfFbPageCommentWithValue});
            return ((bool)(results[0]));
        }
        
        /// <remarks/>
        public void AddCommentDetailsAsync(string JsonObjectOfFbPageCommentWithValue) {
            this.AddCommentDetailsAsync(JsonObjectOfFbPageCommentWithValue, null);
        }
        
        /// <remarks/>
        public void AddCommentDetailsAsync(string JsonObjectOfFbPageCommentWithValue, object userState) {
            ...
            this.InvokeAsync("AddCommentDetails", new object[] {
                        JsonObjectOfFbPageCommentWithValue}, this.AddCommentDetailsOperationCompleted, userState);
        }
        ...
        public bool IsCommentExist(string JsonObjectOfFbPageCommentWithValue) {
        ...
        /// <remarks/>
        public void IsCommentExistAsync(string JsonObjectOfFbPageCommentWithValue) {
            this.IsCommentExistAsync(JsonObjectOfFbPageCommentWithValue, null);
        }
        
        /// <remarks/>
        public void IsCommentExistAsync(string JsonObjectOfFbPageCommentWithValue, object userState) {
            ...
            this.InvokeAsync("IsCommentExist", new object[] {
                        JsonObjectOfFbPageCommentWithValue}, this.IsCommentExistOperationCompleted, userState);
        }
        ...
        public int UpdateFbPageCommentStatus(string JsonObjectOfFbPageCommentWithValue) {
        ...
        /// <remarks/>
        public void UpdateFbPageCommentStatusAsync(string JsonObjectOfFbPageCommentWithValue) {
            this.UpdateFbPageCommentStatusAsync(JsonObjectOfFbPageCommentWithValue, null);
        }
        
        /// <remarks/>
        public void UpdateFbPageCommentStatusAsync(string JsonObjectOfFbPageCommentWithValue, object userState) {
            ...
            this.InvokeAsync("UpdateFbPageCommentStatus", new object[] {
                        JsonObjectOfFbPageCommentWithValue}, this.UpdateFbPageCommentStatusOperationCompleted, userState);
        }
