...
namespace SocioboardDataServices.Api.FbPageLiker {
    ...
    public partial class FbPageLiker : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public bool AddLikeDetails(string JsonObjectOfFbPageLikerWithValue) {
            object[] results = this.Invoke("AddLikeDetails", new object[] {
                        JsonObjectOfFbPageLikerWithValue});
            return ((bool)(results[0]));
        }
        
        /// <remarks/>
        public void AddLikeDetailsAsync(string JsonObjectOfFbPageLikerWithValue) {
            this.AddLikeDetailsAsync(JsonObjectOfFbPageLikerWithValue, null);
        }
        
        /// <remarks/>
        public void AddLikeDetailsAsync(string JsonObjectOfFbPageLikerWithValue, object userState) {
            ...
            this.InvokeAsync("AddLikeDetails", new object[] {
                        JsonObjectOfFbPageLikerWithValue}, this.AddLikeDetailsOperationCompleted, userState);
        }
        ...
        public bool IsLikeExist(string JsonObjectOfFbPageLikerWithValue) {
        ...
        /// <remarks/>
        public void IsLikeExistAsync(string JsonObjectOfFbPageLikerWithValue) {
            this.IsLikeExistAsync(JsonObjectOfFbPageLikerWithValue, null);
        }
        
        /// <remarks/>
        public void IsLikeExistAsync(string JsonObjectOfFbPageLikerWithValue, object userState) {
            ...
            this.InvokeAsync("IsLikeExist", new object[] {
                        JsonObjectOfFbPageLikerWithValue}, this.IsLikeExistOperationCompleted, userState);
        }
