...
namespace GlobusInstagramLib.Instagram.Core.UsersMethods
{
  public  class Users : oAuthBase
    {
        ...
        {
            string url = objoAuthIns.Configuration.ApiBaseUrl + "users/" + userid + "/media/recent?access_token=" + accessToken;
            if (string.IsNullOrEmpty(accessToken))
