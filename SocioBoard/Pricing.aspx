<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/socialsuite.Master" AutoEventWireup="true" CodeBehind="Pricing.aspx.cs" Inherits="SocialSuitePro.MasterPage.Pricing" %>
                         ...
                         <h2>All Plans Include a Free 30-Day Trial</h2>
                            ...
                            <div class="price-shadow-1">
                                    <div class="pricing-list">
                                        <div class="price-head">Basic</div>
                                        <h3>FREE</h3>
                                        <p>Every plan is a unique package. This one fits for individuals.</p>
                                      <ul>
                                        ...
                                        <a id="freePlan"  runat="server" class="trial-butn"><img  src="../Contents/img/trial-butn-1.png" alt="" /></a>
                             ...
                             <div class="price-shadow-1">
                                    <div class="pricing-list">
                                        ...
                                        <p>Comprises of great tools suitable for small teams.</p>
                                      <ul>
                                ...
                                <div class="price-shadow-1">
                                    <div class="pricing-list">
                                        ...
                                        <h3>$49 Per User/Month</h3>
                                        <p>Package you need to efficiently manage an expanding social media network.</p>
                                      <ul>
                                ...
                                <div class="price-shadow-2">
                                    <div class="pricing-list">
                                        ...
                                        <p>Includes sophisticated tools for complex objectives</p>
                                      <ul>
