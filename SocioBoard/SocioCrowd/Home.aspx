<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="SocioCrowd.Home" %>
			...
			<div id="sidebar">
             <div class="sidebar-inner" style="width:255px;">
				...
				<div class="sidebar-inner">
                    ...
                    <span>to connected </span>Social Crowd<ul id="profile-connect" style="width:270px;">
            	...
            	<div id="contentcontainer1">
                	<div id="content">
						<div class="alert alert-suite">
							...
							<p id="divNews" runat="server">Welcome to Social Crowd Your Social Business Partners</p>
