<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="PersonalSettings.aspx.cs" Inherits="SocioCrowd.Settings.PersonalSettings" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>SocialCrowd-TeamMember-PersonalSetting</title>    <link rel="stylesheet" type="text/css" href="../Contents/css/Style_previous.css" />
