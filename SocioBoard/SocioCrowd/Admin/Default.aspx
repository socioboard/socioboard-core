<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SocioCrowd.Admin.Default" %>
...
<!--[if !IE]><!--><html><!-- <![endif]-->
<head>
	<title>Social Crowd - Admin</title>
...
<div id="login">
	...
	<div class="container">
		...
		<div class="wrapper">
			...
			<h1 class="glyphicons lock">Social Crowd Admin <i></i></h1>
