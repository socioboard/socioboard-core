<%@ Page Title="Social Crowd" Language="C#" MasterPageFile="~/MasterPage/socialsuite.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SocialCrowd.Default" %>
  ...
  <%--  <div class="outer-container">
    ...
    <div class="banner-container">
    	<div class="banner-inner">
            ...
            <div class="ban-sub-text">
            	<span>Social Crowd brings proactive social media marketing</span><br />
    ...
    <div class="anim-banner-container" style="position:relative; overflow:hidden;" id="p1">
    	...
    	<div class="anim-banner-inner">
            ...
            <p>People are talking about your brand. Why not join them? Social Crowd allows <br />
            ...
            <div class="ban-img">
            	<div class="mid-circle">
                    ...
                    <div class="mid-white"><span>Social Crowd</span></div>
    ...
    <div class="reason-outer" id="p3">
    	<div class="reason-inner">
        	<h2>some reason </h2>
            <h1>why people like Social Crowd</h1>
    ...
    <div class="anim-banner-container" id="p4">
    	<div class="signup-inner">
        	Try Social Crowd risk-free for 30 days <span><a href="SocialPricing.aspx"><img src="../Contents/img/ssp/signup-butn.png" alt="" align="absmiddle" /></a></span>
        </div>
        <div class="arrow"><ul class="mainnav">
