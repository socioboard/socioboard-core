...
<head>
  ...
  <link rel="shortcut icon" href="../Contents/img/favicon.png">  
    ...
    <script src='<%= Page.ResolveUrl("~/Contents/js/JSlogin.js")%>' type="text/javascript"></script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="container">
			...
			<div class="bg1">
				<div class="logo">
					<a href="#"><img alt='<%=ConfigurationManager.AppSettings["projectName"].ToString() %>' src='<%=ConfigurationManager.AppSettings["projectlogo"].ToString() %>' height="54" width="142"></a>
				</div>
			...
			<div class="bg2">
				<div class="bg-in">
					<header class="title">
						...
						<%=ConfigurationManager.AppSettings["projectName"].ToString() %> takes care of your Social Media like nobody else
					</header>
            ...
            <div class="content">
                ...
                <!--end screens-->
                <header class="title">
				<strong>What people say about <%=ConfigurationManager.AppSettings["projectName"].ToString() %></strong>
	...
	<div class="container">
		...
		<div class="hr"></div>
		Copyright © 2013 <%=ConfigurationManager.AppSettings["projectName"].ToString() %> Ltd.
	</div>
	<!--end container-->
</footer>
    <!--end footer-->
