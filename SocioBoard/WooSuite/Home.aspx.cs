...
namespace WooSuite
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //pack.PackageName = AccountType.Standard.ToString();
            //pack.Pricing = 39.0;
            //pack.Status = true;
            //pack.TotalProfiles = 10;
            //pack.EntryDate = DateTime.Now;
            //packrepo.AddPackage(pack);


            //Package pack1 = new Package();
            //pack1.Id = Guid.NewGuid();
            //pack1.PackageName = AccountType.Deluxe.ToString();
            //pack1.Pricing = 59.0;
            //pack1.Status = true;
            //pack1.TotalProfiles = 20;
            //pack1.EntryDate = DateTime.Now;
            //packrepo.AddPackage(pack1);

            //Package pack2 = new Package();
            //pack2.Id = Guid.NewGuid();
            //pack2.PackageName = AccountType.Premium.ToString();
            //pack2.Pricing = 99.0;
            //pack2.Status = true;
            //pack2.TotalProfiles = 50;
            //pack2.EntryDate = DateTime.Now;
            //packrepo.AddPackage(pack2); 
            #endregion
            ...
            if (!IsPostBack)
            {
                ...
                connect.InnerHtml = "to connect " + prjDet.projectName;
