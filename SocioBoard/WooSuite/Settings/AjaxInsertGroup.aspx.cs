...
namespace WooSuite.Settings
{
    public partial class AjaxInsertGroup : System.Web.UI.Page
    {
        ...
        ILog logger = LogManager.GetLogger(typeof(AjaxInsertGroup));
                    ...
                    foreach (GroupProfile item in lstgroupprofile)
                    {
                        if (item.ProfileType == "facebook")
                        {
                            try
                            {
                                ...
                                bindprofiles +=
                                    "<div id=\"facebook_" + item.ProfileId + "\" class=\"ws_conct\"> <span class=\"img\"><img width=\"48\" height=\"48\" src=\"http://graph.facebook.com/" + item.ProfileId + "/picture?type=small\" alt=\"\"><i><img width=\"16\" height=\"16\" src=\"../Contents/img/fb_icon.png\" alt=\"\"></i></span><div class=\"fourfifth\">" +
