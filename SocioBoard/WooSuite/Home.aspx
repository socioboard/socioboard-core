<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="WooSuite.Home" %>
			...
			<div id="sidebar">
             <div class="sidebar-inner" style="width:255px;">
				...
				<div class="sidebar-inner">
                    ...
                    <span id="connect" runat="server">to connected woo suite</span>
                    <ul id="profile-connect" style="width:270px;">
						<li><a href="#" runat="server" onserverclick="AuthenticateFacebook"><img src="../Contents/img/admin/fbicon.png" alt="" /></a></li>
						<li><a href="#" runat="server" onserverclick="AuthenticateTwitter"><img src="../Contents/img/admin/twittericon.png" alt="" /></a></li>
						<%--<li><a href="#" runat="server" onserverclick="AuthenticateTwitter"><img src="../Contents/img/admin/g+icon.png" alt=""/></a></li>--%>
						<li><a href="#" runat="server" onserverclick="AuthenticateLinkedin"><img src="../Contents/img/admin/linkedinicon.png" alt=""/></a></li>
						<li><a id="A1" href="#" runat="server" onserverclick="AuthenticateInstagram"><img src="Contents/img/instagram_24X24_grey.png" alt=""/></a></li>
						<li>
            	...
            	<div id="contentcontainer1">
                	<div id="content">
						<div class="alert alert-suite">
							...
							<p id="divNews" runat="server">Welcome to WOO SUITE Your Social Business Partners</p>
