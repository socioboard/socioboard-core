<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="~/WooReports/GroupStats.aspx.cs" Inherits="WooSuite.WooReports.GroupStats" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--<link href="<%= Page.ResolveUrl("~/Contents/css/bootstrap.min.css")%>" rel="stylesheet">--%>
    <link href="../Contents/css/admin.css" rel="stylesheet">
    <!--[if IE 7]>
    ...
    <!--[if lt IE 9]>
		...
		<![endif]-->
    <script src="../Contents/js/Chart.js" language="javascript"></script>
</asp:Content>
