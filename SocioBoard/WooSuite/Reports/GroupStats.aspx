<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="GroupStats.aspx.cs" Inherits="WooSuite.Reports.GroupStats" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <%-- <link href="<%= Page.ResolveUrl("~/Contents/css/bootstrap.min.css")%>" rel="stylesheet">--%>
    ...
    <!--[if lt IE 9]>
		...
		<![endif]-->
    <script src="<%= Page.ResolveUrl("~/Contents/js/Chart.js")%>" language="javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style type="text/css">
        ...
        #content{float:left;width:777px;position:relative;left:173px;}
    </style>
        ...
        <div id="sidebar">
            <div class="sidebar-inner">
                <a href="#" class="btn">GROUP REPORT
                    <img src="<%= Page.ResolveUrl("~/Contents/img/admin/boxes.png")%>" alt="" class="pull-right" /></a>
                <a href="FacebookReport.aspx" class="btn">Facebook Pages
                    <img src="<%= Page.ResolveUrl("~/Contents/img/admin/fbicon2.png")%>" alt="" class="pull-right" /></a>
                <a href="TwitterReport.aspx" class="btn">Twitter Reports
                    <img src="<%= Page.ResolveUrl("~/Contents/img/admin/twittericon2.png")%>" alt="" class="pull-right" /></a>
                <a href="TeamReport.aspx" class="btn">Team Report
                    <img src="<%= Page.ResolveUrl("~/Contents/img/admin/peoples.png")%>" alt="" class="pull-right" /></a>
