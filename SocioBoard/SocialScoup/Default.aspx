...
<script type="text/javascript">
    var _urq = _urq || [];
    _urq.push(['initSite', 'fb0fcfab-de7c-48dd-a913-34a1b7136d86']);
    (function () {
  ...
  <%--  <div class="outer-container">
    ...
    <div class="banner-container">
    	<div class="banner-inner">
            ...
            <div class="ban-sub-text">
            	<span>SOCIALSCOUP brings proactive social media marketing</span><br />
    ...
    <div class="anim-banner-container" style="position:relative; overflow:hidden;" id="p1">
    	...
    	<div class="anim-banner-inner">
            ...
            <p>People are talking about your brand. Why not join them? SOCIALSCOUP allows <br />
            ...
            <div class="ban-img">
            	<div class="mid-circle">
                    ...
                    <div class="mid-white"><span>SSCOUP</span></div>
              ...
              <div class="left-pin"><span><a href="#">youR BUSINESS</a></span></div>
                ...
                <div class="right-circle">
                 <span class="worldjunction"><a href="#">WORLDJUNCTION</a></span>
                    <span class="linkedin"><a href="#">LINKEDIN</a></span>
                   ...
                   <span class="mob-apps"><a href="#">MOBILE<br />APPS</a></span>
                    ...
                    <span class="partner"><a href="#">INSTAGRAM</a></span>
              </div>
    ...
    <div class="reason-outer" id="p3">
    	<div class="reason-inner">
        	<h2>some reason </h2>
            <h1>why people like SocialScoup</h1>
    ...
    <div class="anim-banner-container" id="p4">
    	<div class="signup-inner">
        	Try SocialScoup risk-free for 30 days <span><a href="SocialPricing.aspx"><img src="../Contents/img/ssp/signup-butn.png" alt="" align="absmiddle" /></a></span>
        </div>
        <div class="arrow"><ul class="mainnav">
