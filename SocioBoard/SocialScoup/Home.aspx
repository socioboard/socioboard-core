        ...
        <script type="text/javascript">
            ...
            function addimg(str) {
                ...
                if (str.indexOf('http') != -1) {
                   var arr = str.split('/');
                   window.open('http://'+arr[2], '_blank');
                }
                else {
                    var arr = str.split('/');
                    window.open('http://'+arr[0], '_blank');
                }          
            }
        </script>
</asp:Content>
			...
			<div id="sidebar">
             <div class="sidebar-inner" style="width:255px;">
				...
				<div class="sidebar-inner">
                    ...
                    <span>to connected </span>SocialScoup<ul id="profile-connect" style="width:270px;">
				...
				<div class="sidebar-inner">
                <a class="addimg" runat="server">
                    <asp:Image ID="imgAds" onclick="addimg(this.src);" runat="server" ImageUrl="../Contents/img/admin/ads.png"/>
                    </a>
            	...
            	<div id="contentcontainer1">
                	<div id="content">
						<div class="alert alert-suite">
							...
							<p id="divNews" runat="server">Welcome to SocialScoup Your Social Business Partners</p>
