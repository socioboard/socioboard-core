    ...
    public partial class Home : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                   ...
                   // ScriptManager.RegisterStartupScript(this, GetType(), "Paypall Success", "alert('above activation!');", true);
        ...
        public void getgrphData()
        {
            try
            {
                ...
                spanIncoming.InnerHtml = Session["CountMessages"].ToString();
        ...
        public void AuthenticateFacebook(object sender, EventArgs e)
        {
            try
            {
                ...
                if (profilecount < totalaccount)
                {
                    ...
                    Response.Redirect(fb_account.HRef); //fb_account.HRef
                }
                else
                {
                    Response.Write("<script type=\"text/javascript\">alert('Change the Plan to Add More Accounts');</script>");
                }
            }
            catch (Exception ex)
            {
