...
namespace SocialSuitePro.Helper
{
    public class MailHelper
    {
        ...
        public static string SendSendGridMailNew(string Host, int port, string from, string passsword, string to, string bcc, string cc, string subject, string body, string sendgridUserName, string sendgridPassword)
        {
            ...
            catch (Exception ex)
            {
                ...
                catch (Exception ex1)
                {
                    Console.WriteLine(ex1.Message);
                    logger.Error(ex1.Message);
                    ret = " -------Message---- " + ex1.Message + " -------StackTrace---- " + ex1.StackTrace;
                }
            }
            return ret;
        }
        ...
        private string SendMailByMandrill(string Host, int port, string from, string passsword, string to, string bcc, string cc, string subject, string body, string sendgridUserName, string sendgridPassword)
        {
