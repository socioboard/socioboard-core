...
function SendMessage() {
    ...
    try {
        ...
        if (hasExtension('fileuploadImage', fileExtension)) {
         ...
         {
            alert("File Extention is not correct. Please upload any image file");
            return;  
         }
         }
                 ...
                 $("#sendMessageBtn").html('<img src="../Contents/img/sendbtn.png" alt="" />');
                   $("#composeBox").bPopup().close();
                    ...
                    document.getElementById('fileuploadImage').value = "";
                     ...
                     if(arrmsg[1].indexOf("Successfully")==-1)
                     {
                         alertify.success(arrmsg[0]);
                         closeonCompose();
                     }
                     else
                     {
...
function getAllNetworkProfile() {
      // alert("asd");
        $(".getAllNetworkProfile").each(function (index) {
     var chk= $(this).attr('onclick')
    //if(chk.contains('addAnotherProfileforMessage'))
     if(chk.indexOf('addAnotherProfileforMessage')!=-1)
     {
     var pid=$(this).attr('id');
     var ntwk=$(this).attr('nwtk')
     addAnotherProfileforMessage(pid,ntwk);
           // alert($(this).attr('id'));
             //console.log(index + ": " + $(this).html());
            //console.log($("ul.getAllNetworkProfile"));
