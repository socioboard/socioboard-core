...
namespace Socioboard.Api.YoutubeAccount {
    ...
    public partial class YoutubeAccount : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void DeleteYoutubeAccountAsync(string UserId, string ProfileId, string GroupId, string profiletype) {
            this.DeleteYoutubeAccountAsync(UserId, ProfileId, GroupId, profiletype, null);
        }
        
        /// <remarks/>
        public void DeleteYoutubeAccountAsync(string UserId, string ProfileId, string GroupId, string profiletype, object userState) {
            ...
            this.InvokeAsync("DeleteYoutubeAccount", new object[] {
                        ...
                        ProfileId,
                        GroupId,
                        profiletype}, this.DeleteYoutubeAccountOperationCompleted, userState);
        }
