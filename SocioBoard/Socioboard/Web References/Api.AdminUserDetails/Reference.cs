...
namespace Socioboard.Api.AdminUserDetails {
    ...
    public partial class AdminUserDetails : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetUserDataForDataTableOperationCompleted;
        ...
        /// <remarks/>
        public event GetUserDataForDataTableCompletedEventHandler GetUserDataForDataTableCompleted;
        ...
        /// <remarks/>
        public void UpdateUserAccountAsync(string Id, string UserName, string EmailId, string Package, string Status, string PaymentStatus) {
            this.UpdateUserAccountAsync(Id, UserName, EmailId, Package, Status, PaymentStatus, null);
        }
        
        /// <remarks/>
        public void UpdateUserAccountAsync(string Id, string UserName, string EmailId, string Package, string Status, string PaymentStatus, object userState) {
            ...
            this.InvokeAsync("UpdateUserAccount", new object[] {
                        ...
                        Package,
                        Status,
                        PaymentStatus}, this.UpdateUserAccountOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetUserDataForDataTable", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string GetUserDataForDataTable(string user, string iDisplayLength, string iDisplayStart, string iSortCol_0, string sSortDir_0, string sSearch) {
            object[] results = this.Invoke("GetUserDataForDataTable", new object[] {
                        user,
                        iDisplayLength,
                        iDisplayStart,
                        iSortCol_0,
        ...
        /// <remarks/>
        public void GetUserDataForDataTableAsync(string user, string iDisplayLength, string iDisplayStart, string iSortCol_0, string sSortDir_0, string sSearch) {
            this.GetUserDataForDataTableAsync(user, iDisplayLength, iDisplayStart, iSortCol_0, sSortDir_0, sSearch, null);
        }
        
        /// <remarks/>
        public void GetUserDataForDataTableAsync(string user, string iDisplayLength, string iDisplayStart, string iSortCol_0, string sSortDir_0, string sSearch, object userState) {
            if ((this.GetUserDataForDataTableOperationCompleted == null)) {
                this.GetUserDataForDataTableOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetUserDataForDataTableOperationCompleted);
            }
            this.InvokeAsync("GetUserDataForDataTable", new object[] {
                        user,
                        iDisplayLength,
                        iDisplayStart,
                        iSortCol_0,
                        sSortDir_0,
                        sSearch}, this.GetUserDataForDataTableOperationCompleted, userState);
        }
        
        private void OnGetUserDataForDataTableOperationCompleted(object arg) {
            if ((this.GetUserDataForDataTableCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetUserDataForDataTableCompleted(this, new GetUserDataForDataTableCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void GetUserDataForDataTableCompletedEventHandler(object sender, GetUserDataForDataTableCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetUserDataForDataTableCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetUserDataForDataTableCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
