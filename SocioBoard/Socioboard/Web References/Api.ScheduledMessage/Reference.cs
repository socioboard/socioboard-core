...
namespace Socioboard.Api.ScheduledMessage {
    ...
    public partial class ScheduledMessage : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesOperationCompleted;
        ...
        /// <remarks/>
        public event GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompletedEventHandler GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompleted;
        ...
        /// <remarks/>
        public void AddAllScheduledMessageAsync(string typeandid, string ShareMessage, string ClientTime, string scheduleddate, string scheduletime, string UserId, string PicUrl, string url) {
            this.AddAllScheduledMessageAsync(typeandid, ShareMessage, ClientTime, scheduleddate, scheduletime, UserId, PicUrl, url, null);
        }
        
        /// <remarks/>
        public void AddAllScheduledMessageAsync(string typeandid, string ShareMessage, string ClientTime, string scheduleddate, string scheduletime, string UserId, string PicUrl, string url, object userState) {
            ...
            this.InvokeAsync("AddAllScheduledMessage", new object[] {
                        ...
                        UserId,
                        PicUrl,
                        url}, this.AddAllScheduledMessageOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetSociaoQueueMessageByUserIdAndGroupIdBetweenDates", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string GetSociaoQueueMessageByUserIdAndGroupIdBetweenDates(string UserId, string GroupId, string StartDate, string EndDate) {
            object[] results = this.Invoke("GetSociaoQueueMessageByUserIdAndGroupIdBetweenDates", new object[] {
                        UserId,
                        GroupId,
                        StartDate,
                        EndDate});
        ...
        /// <remarks/>
        public void GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesAsync(string UserId, string GroupId, string StartDate, string EndDate) {
            this.GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesAsync(UserId, GroupId, StartDate, EndDate, null);
        }
        
        /// <remarks/>
        public void GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesAsync(string UserId, string GroupId, string StartDate, string EndDate, object userState) {
            if ((this.GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesOperationCompleted == null)) {
                this.GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesOperationCompleted);
            }
            this.InvokeAsync("GetSociaoQueueMessageByUserIdAndGroupIdBetweenDates", new object[] {
                        UserId,
                        GroupId,
                        StartDate,
                        EndDate}, this.GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesOperationCompleted, userState);
        }
        
        private void OnGetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesOperationCompleted(object arg) {
            if ((this.GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompleted(this, new GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompletedEventHandler(object sender, GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetSociaoQueueMessageByUserIdAndGroupIdBetweenDatesCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
