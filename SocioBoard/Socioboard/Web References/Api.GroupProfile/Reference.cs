...
namespace Socioboard.Api.GroupProfile {
    ...
    public partial class GroupProfile : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void DeleteProfileFromGroupAsync(string profileid, string groupid, string userid, string ProfileType) {
            this.DeleteProfileFromGroupAsync(profileid, groupid, userid, ProfileType, null);
        }
        
        /// <remarks/>
        public void DeleteProfileFromGroupAsync(string profileid, string groupid, string userid, string ProfileType, object userState) {
            ...
            this.InvokeAsync("DeleteProfileFromGroup", new object[] {
                        ...
                        groupid,
                        userid,
                        ProfileType}, this.DeleteProfileFromGroupOperationCompleted, userState);
        }
