...
namespace Socioboard.Api.GooglePlusAccount {
    ...
    public partial class GooglePlusAccount : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void DeleteGplusAccountAsync(string UserId, string ProfileId, string GroupId, string profiletype) {
            this.DeleteGplusAccountAsync(UserId, ProfileId, GroupId, profiletype, null);
        }
        
        /// <remarks/>
        public void DeleteGplusAccountAsync(string UserId, string ProfileId, string GroupId, string profiletype, object userState) {
            ...
            this.InvokeAsync("DeleteGplusAccount", new object[] {
                        ...
                        ProfileId,
                        GroupId,
                        profiletype}, this.DeleteGplusAccountOperationCompleted, userState);
        }
