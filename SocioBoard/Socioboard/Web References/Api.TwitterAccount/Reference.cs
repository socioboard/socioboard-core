...
namespace Socioboard.Api.TwitterAccount {
    ...
    public partial class TwitterAccount : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback AddTwitterAccountFromTweetBoardOperationCompleted;
        
        private System.Threading.SendOrPostCallback retrievetwitterdataOperationCompleted;
        ...
        /// <remarks/>
        public event AddTwitterAccountFromTweetBoardCompletedEventHandler AddTwitterAccountFromTweetBoardCompleted;
        
        /// <remarks/>
        public event retrievetwitterdataCompletedEventHandler retrievetwitterdataCompleted;
        ...
        /// <remarks/>
        public void DeleteTwitterAccountAsync(string UserId, string ProfileId, string GroupId, string ProfileType) {
            this.DeleteTwitterAccountAsync(UserId, ProfileId, GroupId, ProfileType, null);
        }
        
        /// <remarks/>
        public void DeleteTwitterAccountAsync(string UserId, string ProfileId, string GroupId, string ProfileType, object userState) {
            ...
            this.InvokeAsync("DeleteTwitterAccount", new object[] {
                        ...
                        ProfileId,
                        GroupId,
                        ProfileType}, this.DeleteTwitterAccountOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/AddTwitterAccountFromTweetBoard", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string AddTwitterAccountFromTweetBoard(string UserId, string GroupId, string OAuthToken, string OAuthSecret, string ProfileId, string ScreenName, string FollowingCount, string FollowerCount, string ProfilePicUrl) {
            object[] results = this.Invoke("AddTwitterAccountFromTweetBoard", new object[] {
                        UserId,
                        GroupId,
                        OAuthToken,
                        OAuthSecret,
        ...
        /// <remarks/>
        public void AddTwitterAccountFromTweetBoardAsync(string UserId, string GroupId, string OAuthToken, string OAuthSecret, string ProfileId, string ScreenName, string FollowingCount, string FollowerCount, string ProfilePicUrl) {
            this.AddTwitterAccountFromTweetBoardAsync(UserId, GroupId, OAuthToken, OAuthSecret, ProfileId, ScreenName, FollowingCount, FollowerCount, ProfilePicUrl, null);
        }
        
        /// <remarks/>
        public void AddTwitterAccountFromTweetBoardAsync(string UserId, string GroupId, string OAuthToken, string OAuthSecret, string ProfileId, string ScreenName, string FollowingCount, string FollowerCount, string ProfilePicUrl, object userState) {
            if ((this.AddTwitterAccountFromTweetBoardOperationCompleted == null)) {
                this.AddTwitterAccountFromTweetBoardOperationCompleted = new System.Threading.SendOrPostCallback(this.OnAddTwitterAccountFromTweetBoardOperationCompleted);
            }
            this.InvokeAsync("AddTwitterAccountFromTweetBoard", new object[] {
                        UserId,
                        GroupId,
                        OAuthToken,
                        OAuthSecret,
                        ...
                        FollowingCount,
                        FollowerCount,
                        ProfilePicUrl}, this.AddTwitterAccountFromTweetBoardOperationCompleted, userState);
        }
        
        private void OnAddTwitterAccountFromTweetBoardOperationCompleted(object arg) {
            if ((this.AddTwitterAccountFromTweetBoardCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.AddTwitterAccountFromTweetBoardCompleted(this, new AddTwitterAccountFromTweetBoardCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/retrievetwitterdata", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string retrievetwitterdata(string id) {
            object[] results = this.Invoke("retrievetwitterdata", new object[] {
                        id});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void retrievetwitterdataAsync(string id) {
            this.retrievetwitterdataAsync(id, null);
        }
        
        /// <remarks/>
        public void retrievetwitterdataAsync(string id, object userState) {
            if ((this.retrievetwitterdataOperationCompleted == null)) {
                this.retrievetwitterdataOperationCompleted = new System.Threading.SendOrPostCallback(this.OnretrievetwitterdataOperationCompleted);
            }
            this.InvokeAsync("retrievetwitterdata", new object[] {
                        id}, this.retrievetwitterdataOperationCompleted, userState);
        }
        
        private void OnretrievetwitterdataOperationCompleted(object arg) {
            if ((this.retrievetwitterdataCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.retrievetwitterdataCompleted(this, new retrievetwitterdataCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void AddTwitterAccountFromTweetBoardCompletedEventHandler(object sender, AddTwitterAccountFromTweetBoardCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class AddTwitterAccountFromTweetBoardCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal AddTwitterAccountFromTweetBoardCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void retrievetwitterdataCompletedEventHandler(object sender, retrievetwitterdataCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class retrievetwitterdataCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal retrievetwitterdataCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
