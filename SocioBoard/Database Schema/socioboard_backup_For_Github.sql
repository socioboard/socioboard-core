...
# Dumping structure for table abhay1.package
DROP TABLE IF EXISTS `package`;
CREATE TABLE IF NOT EXISTS `package` (
  `Id` binary(16) NOT NULL,
  `PackageName` varchar(100) DEFAULT NULL,
...
# Dumping data for table abhay1.package: 4 rows
/*!40000 ALTER TABLE `package` DISABLE KEYS */;
INSERT INTO `package` (`Id`, `PackageName`, `Pricing`, `EntryDate`, `Status`, `TotalProfiles`) VALUES ('I�h��M�PD�p��', 'Standard', 29, '2013-12-18 12:40:08', 1, 2), ('�,6>��D��p���', 'Free', 0, '2013-12-18 11:37:32', 1, 2), ('�:�;$�A��Ja�uj', 'Deluxe', 89, '2013-12-18 13:00:37', 1, 2), ('��ګ�o�E���<,��g', 'Premium', 49, '2013-12-18 12:40:04', 1, 50);
