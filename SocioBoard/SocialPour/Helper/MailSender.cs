    ...
    public class MailSender
    {
        ...
        public static void SendEMail(string username, string password, string emailid, string id)
        {
            ...
            try
            {
                ...
                html = html.Replace("%replink%", "http://socialpour.com/Home.aspx?stat=activate");
                ...
                string Subject = "You have Added to Socialpour Account";
        ...
        public static void SendInvitationEmail(string username, string sendername, string email,Guid teamid)
        {
            try
            {
                ...
                string port = ConfigurationManager.AppSettings["port"];
                string pass = ConfigurationManager.AppSettings["password"];
                string urllogin = "http://socialpour.com//Default.aspx";
                string registrationurl = "http://socialpour.com/Registration.aspx?tid=" + teamid;
                string Body = mailhelper.InvitationMail(html, username, sendername, "", urllogin, registrationurl);
                string Subject = "You've been Invited to " + username + " Socialpour Account";
