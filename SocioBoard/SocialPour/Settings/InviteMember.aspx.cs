            ...
            try
            {
                            ...
                            if (rbAdmin.Checked || rbUser.Checked)
                            {
                                ...
                                if (AccessLevel != string.Empty)
                                {
                                    ...
                                    if (totalchkboxesArray.Count() != 0)
                                    {
                                      ...
                                      //  ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Invitation Sends');", true);
                                        Response.Write("<script>alert(\"Invitation Sends\");</script>");
                ...
                else
                {
                   // ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "MyFun1", "disp_confirm();", true);
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Select accounts you want send Invitation');", true);
                }
