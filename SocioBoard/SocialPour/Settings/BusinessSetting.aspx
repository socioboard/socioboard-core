        ...
        <div class="ws_tm_mid">                    	
                        <div class="ws_tm_personal_setting">
                           ...
                           <div class="personal_setting_left">
                                ...
                                <div class="ws_ps_user_content">                                	
                                    <div class="personal_details">
                                    	SocialScoup alerts you & your team members via email on various activities.
                                    </div>
                                    <div class="radio_content">
                                ...
                                <div class="ws_ps_user_content">                                	
                                    <div class="personal_details">
                                        ...
                                        dedicated album titled SocialScoup Photos. You are able to rename the SocialScoup album within Facebook.
                                    </div>
                                    <div class="radio_content">
                                            <asp:RadioButton ID="rbFbTimeLine" runat="server" Text="Facebook Timeline" 
                                                GroupName="D" />                                             
                                            <asp:RadioButton ID="rbFbWooSuitePhotos" runat="server" Text="SocialScoup Photos" 
                                                GroupName="D" />  
                                </div>
