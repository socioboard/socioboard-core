<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="WooSuite.Registration" %>
...
<body class="login">
    ...
    <div class="logo_login"><img src="Contents/img/woosuite_logo.png" alt="" /></div>
    ...
    <div class="login_reg_bg">
       ...
       <div class="reg_temp_reg">
         ...
         <div class="left_reg_area">
            <div class="inputbg"><asp:TextBox ID="txtFirstName" onkeypress="onlyAlphabets();" runat="server" placeholder="First Name"></asp:TextBox></div>
