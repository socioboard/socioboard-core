<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="FacebookReport.aspx.cs" Inherits="WooSuite.Reports.FacebookReport" %>
...
<div id="mainwrapper" class="container reports">
			<div id="sidebar">            	
				<div class="sidebar-inner">
                	...
                	<a href="#" class="btn" id="facebook_page">Facebook Pages <img src="<%=Page.ResolveUrl("~/Contents/img/admin/fbicon2.png")%>" alt="" class="pull-right" /></a>
					...
					<a href="TeamReport.aspx" class="btn">Team Report <img src="<%=Page.ResolveUrl("~/Contents/img/admin/peoples.png")%>" alt="" class="pull-right" /></a>
            	...
            	<div id="contentcontainer-report">
                	<div id="content" style="left:0;">
                        ...
                        <div class="rounder shadower pull-left reportcontent" style="padding-right:20px; width:895px;">
                            ...
                            <div class="fb-page-profilimg"><img src="<%=Page.ResolveUrl("~/Contents/img/avathar-1.jpg")%>" alt="" id="fbProfileImg" runat="server"></div>
                            
                          <div class="fb-graph-right">
                                <div class="fb-graph-right-header">
                                	<div class="fb-graph-right-head-left">
                                        <h2 id="divPageName" runat="server">"We Want Arvind Kejriwal as Indian PM"</h2><br>
                            ...
                            <%--<div class="impression-break-container">
                                ...
                                <div class="impress-location">
                                    ...
                                    <div class="top-countries-outer">
                                        ...
                                        <div class="country-list"><img src="<%=Page.ResolveUrl("~/Contents/img/flag-india.jpg" alt="" /><br />2.0 m</div>
                                        <div class="country-list"><img src="<%=Page.ResolveUrl("~/Contents/img/flag-us.jpg" alt="" /><br />69.7k</div>
                                        <div class="country-list"><img src="<%=Page.ResolveUrl("~/Contents/img/flag-uae.jpg" alt="" /><br />23.9k</div>
                                        <div class="country-list"><img src="<%=Page.ResolveUrl("~/Contents/img/flag-uk.jpg" alt="" /><br />21.3k</div>
                                        <div class="country-list"><img src="<%=Page.ResolveUrl("~/Contents/img/flag-eng.jpg" alt="" /><br />18.0k</div>
                                        <div class="clear"></div>
                                    </div>
                          ...
                          <div class="stories-graph-right">
                                <div class="stories-graph-head">
                                    ...
                                    <div class="stories-graph-right-head">
                                    	<img src="<%=Page.ResolveUrl("~/Contents/img/graph-icon.jpg")%>" alt="" align="absmiddle" />Stories Created <strong><div id="storiescount" runat="server"> </strong><%-- <span><img src="<%=Page.ResolveUrl("~/Contents/img/graph-icon2.jpg" alt="" align="absmiddle" /> by 127.5k Users</span>--%>
                                    </div>
                                    <div class="clear"></div>
                                </div>
        ...
        <script src="<%=Page.ResolveUrl("~/Contents/js/RGraph.bar.js")%>"></script>
             <script src="<%=Page.ResolveUrl("~/Contents/js/Chart.js")%>"></script>
        <style>
			canvas{
			}
		</style> 
