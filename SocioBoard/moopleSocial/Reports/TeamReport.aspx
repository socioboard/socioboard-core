<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="TeamReport.aspx.cs" Inherits="WooSuite.Reports.TeamReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<script type="text/javascript" src="<%=Page.ResolveUrl("~/Contents/js/progressbar.js")%>"></script>
                	...
                	<div id="content" style="left:0;">
                        ...
                        <div class="rounder shadower pull-left reportcontent" style="padding-right:20px; width:895px;">
                            ...
                            <div class="publish-list">
                            	<div class="avathar-pub"><img src="<%=Page.ResolveUrl("~/Contents/img/avathar-1.jpg")%>" alt="" /></div>
                        ...
                        <div class="rounder shadower pull-left reportcontent" style="padding-right:20px; width:895px;">
                        	<div class="header-outer">
                            	<h1>TASKS</h1>
                                <div class="date-head"><img src="<%=Page.ResolveUrl("~/Contents/img/help-icon.png")%>" alt="" align="absmiddle" /><span id="spanDate" runat="server"> Apr. 15, 2013 - Apr. 29, 2013</span></div>
                                <div class="clear"></div>
                            </div>
                            <div class="task-list-outer" id="taskdiv" runat="server" style="width:auto;">
