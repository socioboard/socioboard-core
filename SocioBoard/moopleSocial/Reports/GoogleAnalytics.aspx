<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="GoogleAnalytics.aspx.cs" Inherits="WooSuite.Reports.GoogleAnalytics" %>
...
<div id="sidebar">            	
	<div class="sidebar-inner">
        <a class="btn" href="GroupStats.aspx">GROUP REPORT <img class="pull-right" alt="" src="<%=Page.ResolveUrl("~/Contents/img/admin/boxes.png")%>"></a>
        ...
        <a class="btn" href="#">Google Analytics Report <img class="pull-right" alt="" src="<%=Page.ResolveUrl("~/Contents/img/admin/peoples.png")%>"></a>				
	</div>				
</div>
            ...
            <div class="postContent">
                ...
                <div class="twitter_drop_down_and_tweet_box">
                    ...
                    <div class="insight_btn">
                        ...
                        <asp:ImageButton ID="btnGa" runat="server" Height="35" ImageUrl="<%=Page.ResolveUrl("~/Contents/img/btn_analytics.png")%>" OnClick="btnAnalytics_Click" Width="104" />
                    </div>
