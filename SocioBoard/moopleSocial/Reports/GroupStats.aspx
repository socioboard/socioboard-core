<%@ Page Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="GroupStats.aspx.cs" Inherits="WooSuite.Reports.GroupStats" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <link href="<%=Page.ResolveUrl("~/<%=Page.ResolveUrl("~/Contents/css/admin.css")%>" rel="stylesheet">
    <!--[if IE 7]>
			<link href="<%=Page.ResolveUrl("~/<%=Page.ResolveUrl("~/Contents/css/font-awesome-ie7.min.css")%>" rel="stylesheet">
		<![endif]-->
    <!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
    <!--[if lt IE 9]>
			<script src="<%=Page.ResolveUrl("~/<%=Page.ResolveUrl("~/Contents/js/html5shiv.js")%>"></script>
		<![endif]-->
    <script src="<%=Page.ResolveUrl("~/<%=Page.ResolveUrl("~/Contents/js/Chart.js")%>"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="exportReport" runat="server">
    <div id="mainwrapper" class="container reports">
        <div id="sidebar">
            <div class="sidebar-inner">
                <a href="#" class="btn">GROUP REPORT
                    <img src="<%=Page.ResolveUrl("~/<%=Page.ResolveUrl("~/Contents/img/admin/boxes.png")%>" alt="" class="pull-right" /></a>
                <a href="FacebookReport.aspx" class="btn">Facebook Pages
                    <img src="<%=Page.ResolveUrl("~/<%=Page.ResolveUrl("~/Contents/img/admin/fbicon2.png")%>" alt="" class="pull-right" /></a>
                <a href="TwitterReport.aspx" class="btn">Twitter Reports
                    <img src="<%=Page.ResolveUrl("~/<%=Page.ResolveUrl("~/Contents/img/admin/twittericon2.png")%>" alt="" class="pull-right" /></a>
                <a href="TeamReport.aspx" class="btn">Team Report
                    <img src="<%=Page.ResolveUrl("~/<%=Page.ResolveUrl("~/Contents/img/admin/peoples.png")%>" alt="" class="pull-right" /></a>
                ...
                <%--	<a href="#" class="btn">Twitter Comparison <img src="<%=Page.ResolveUrl("~/Contents/img/admin/loopback.png")%>" alt="" class="pull-right" /></a>
					<a href="#" class="btn">Sent Message <img src="<%=Page.ResolveUrl("~/Contents/img/admin/bar-chart.png")%>" alt="" class="pull-right" /></a>				--%>
            </div>
        </div>
            ...
            <div id="content" style="margin-left: -115px; width: 855px;">
                <%--<div class="alert alert-suite-grey">
                            ...
                            <div id="exportdt" class="pull-right">
                            	<img src="<%=Page.ResolveUrl("~/Contents/img/admin/tt.png" class="help" alt="" title="This is tooltip"/>
                                ...
                                <button class="togl btn"><img src="<%=Page.ResolveUrl("~/Contents/img/admin/add.png" alt="" style="margin-top:-5px"/></button>
                ...
                <div class="rounder shadower pull-left reportcontent">
                    <div class="row-fluid">
                        ...
                        <div class="span5">
                            <div class="pull-right">
                                <%--<img src="<%=Page.ResolveUrl("~/Contents/img/admin/groupstats.png" alt=""/>--%>
                                <ul class="graphdiv">
                                    <li class="maingraph">
                                        <div class="contents">
                                            <span class="value">
                    ...
                    <div class="ttr">
                        <a href="#">
                            <img src="<%=Page.ResolveUrl("~/Contents/img/admin/ttred.png")%>" alt="" /></a></div>
                </div>
                <div class="alert alert-suite-grey">
                    <div class="title">
                ...
                <div class="rounder shadower pull-left reportcontent">
                    <div class="row-fluid">
                        ...
                        <div class="span4" style="text-align: center">
                            <%--  <h5>YOUR RANK IN THE</h5>
                                	<img src="<%=Page.ResolveUrl("~/Contents/img/admin/19.png" alt=""/>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4" style="text-align: center">
                            <%--	<img src="<%=Page.ResolveUrl("~/Contents/img/admin/estimateinbound.png" alt=""/>       --%>
                        </div>
                    </div>
                    <div class="ttr">
                        <a href="#">
                ...
                <div class="rounder shadower pull-left reportcontent">
                    <div class="row-fluid">
                        <div class="span6">
                            ...
                            <div class="row-fluid">
                                <div class="span6" style="width: 47.936%;">
                                    <img class="pull-left" src="<%=Page.ResolveUrl("~/Contents/img/admin/24.png")%>" alt="" />
                                ...
                                <div class="span6" style="width: 47.936%;">
                                    <img class="pull-left" src="<%=Page.ResolveUrl("~/Contents/img/admin/25.png")%>" alt="" />
                                    <div class="pull-left" style="margin-left: 10px">
                                        <h2 ><div id="divtwtfeMale" runat="server"></div>
                                            </h2>
                                        <br />
                                        <span>Female
                                            <br />
                        ...
                        <div class="span6">
                            <h5>
                                Twitter Stats</h5>
                            <img src="<%=Page.ResolveUrl("~/Contents/img/admin/23.png")%>" alt="">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            <div class="row-fluid">
                                <div class="span4">
                                    <img src="<%=Page.ResolveUrl("~/Contents/img/admin/26.png")%>" alt="" />
                                ...
                                <div class="span4">
                                    <img src="<%=Page.ResolveUrl("~/Contents/img/admin/28.png")%>" alt="" />
                                ...
                                <div class="span4">
                                    <img src="<%=Page.ResolveUrl("~/Contents/img/admin/27.png")%>" alt="" />
                  ...
                  <%--      <div class="span7">
                        ...
                        <%--           <div class="span5">
                                    ...
                                    <ul class="groupstat">
                                    	<li><img src="<%=Page.ResolveUrl("~/Contents/img/admin/29.png" alt=""/><h2 style="margin-right:10px;color:#cb786f;width:50px;display:inline-block">20</h2><span>Plain Text</span></li>
                                    	<li><img src="<%=Page.ResolveUrl("~/Contents/img/admin/30.png" alt=""/><h2 style="margin-right:10px;color:#cb786f;width:50px;display:inline-block">0</h2>Links to Pages</li>
                                    	<li><img src="<%=Page.ResolveUrl("~/Contents/img/admin/31.png" alt=""/><h2 style="margin-right:10px;color:#cb786f;width:50px;display:inline-block">0</h2>Photo Links</li>                                        
                                    </ul>
                                </div>--%>
                    </div>
                </div>
