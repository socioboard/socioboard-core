<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="TwitterReport.aspx.cs" Inherits="WooSuite.Reports.TwitterReport" %>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a id="facebook_connect">
                                                                <img width="18" border="none" style="float:left;" alt="" src="<%=Page.ResolveUrl("~/Contents/img/facebook.png")%>" />
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a id="TwitterOAuth" runat="server">
                                                                <img width="18" border="none" style="float:left;" alt="" src="<%=Page.ResolveUrl("~/Contents/img/twitter.png")%>" />
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a id="LinkedInLink"  runat="server">
                                                                <img width="18" border="none" style="float:left;" alt="" src="<%=Page.ResolveUrl("~/Contents/img/link.png")%>" />
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a id="InstagramConnect"  runat="server">
                                                                <img width="18" border="none" style="float:left;" alt=""  src="<%=Page.ResolveUrl("~/Contents/img/instagram_24X24.png")%>" />
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a id="GooglePlusConnect"  runat="server" >
                                                                <img width="18" border="none" style="float:left;" alt=""  src="<%=Page.ResolveUrl("~/Contents/img/google_plus.png")%>" />
                            	...
                            	<div class="user-details-outer">
                                	<div class="nam-photo">
                                    	<div class="avathar-pub">
                                            <asp:Image ID="profileImg" runat="server" /> <%--<img src="<%=Page.ResolveUrl("~/Contents/img/avathar-1.jpg" alt="" />--%></div>
