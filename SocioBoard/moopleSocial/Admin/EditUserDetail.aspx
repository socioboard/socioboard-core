<%@ Page Title="WooSuite" Language="C#" MasterPageFile="~/MasterPage/adminSite.Master" AutoEventWireup="true" CodeBehind="EditUserDetail.aspx.cs" Inherits="WooSuite.Admin.EditUserDetail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script src="<%=Page.ResolvedUrl("~/Contents/js/jquery.min.js")%>" type="text/javascript"></script>
