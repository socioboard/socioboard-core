<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WooSuite.Admin.Default" %>
...
<!--[if !IE]><!--><html><!-- <![endif]-->
<head>
	<title>Moople Social - Admin</title>
	...
	<!-- Bootstrap -->
    <link href="../Contents/common/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css" />
...
<div id="login">
	...
	<div class="container">
		...
		<div class="wrapper">
			...
			<h1 class="glyphicons lock">Moople Social Admin <i></i></h1>
