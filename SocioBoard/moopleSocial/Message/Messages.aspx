<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Messages.aspx.cs" Inherits="WooSuite.Message.Messages" %>
...
@keyframes loading-7 {
    ...
    <script src="<%=Page.ResolveUrl("~/Contents/js/modernizr.custom.63321.js")%>" type="text/javascript"></script>
<link href='http://fonts.googleapis.com/css?family=Racing+Sans+One' rel='stylesheet' type='text/css'>
        <div id="mainwrapper-message" class="container">
			<div id="sidebar">
				<div class="sidebar-inner">
                	<a id="smart_inbox" href="Messages.aspx" class="btn active"><img src="<%=Page.ResolveUrl("~/Contents/img/admin/chatbtn.png")%>" alt="" >Smart Inbox <span runat="server" id="blackcount" class="info"></span></a>
                	<a id="task_href" href="Task.aspx" class="btn"><img src="<%=Page.ResolveUrl("~/Contents/img/admin/markerbtn.png")%>" alt="" >My Task</a>
                    <a id="sent_messages" href="#" onclick="BindInboxMessageonMessageTab();" class="btn"><img src="<%=Page.ResolveUrl("~/Contents/img/admin/envbtn.png")%>" alt="" >Sent Message</a>
                    <a id="archive_message" href="#" onclick="BindArchiveMessages();" class="btn"><img src="<%=Page.ResolveUrl("~/Contents/img/admin/envbtn.png")%>" alt="" >Archive Message</a>
                ...
                <div class="accordion-group">
                  ...
                  <div class="accordion-body collapse in" id="collapseOne">
                    <div id="accordianprofiles" class="accordion-inner">
                      <ul>
                      <li>
                      <img src="<%=Page.ResolveUrl("~/Contents/img/ajax-loader.gif")%>" alt="" />
                      </li>
                    ...
                    <div class="accordion-inner">
                        <ul>                        
                      	<li class="messagetype">
                        	<a href="#"><img src="<%=Page.ResolveUrl("~/Contents/img/admin/twittericon.png")%>" width="15" height="15" alt=""/>Mentions</a>
                            <img onclick="chkMessage(this.id);" id="check_mentions" src="<%=Page.ResolveUrl("~/Contents/img/check_click.png")%>" alt="" />
                        </li>
                      	<li class="messagetype">
                        	<a href="#"><img src="<%=Page.ResolveUrl("~/Contents/img/admin/twittericon.png")%>" width="15" height="15" alt=""/>User Tweets</a>
                      <img onclick="chkMessage(this.id);" id="check_Retweets" src="<%=Page.ResolveUrl("~/Contents/img/check_click.png")%>" alt="" />
                        </li>
                      	<li class="messagetype">
                        	<a href="#"><img src="<%=Page.ResolveUrl("~/Contents/img/google_plus.png")%>" width="15" height="15" alt="" />Activities</a>
                       <img onclick="chkMessage(this.id);" id="check_Activities" src="<%=Page.ResolveUrl("~/Contents/img/check_click.png")%>" alt="" />
                        </li>
                      	<li class="messagetype">
                        	<a href="#"><img src="<%=Page.ResolveUrl("~/Contents/img/admin/fbicon.png")%>" width="15" height="15" alt=""/>User Feeds</a>
                         <img onclick="chkMessage(this.id);" id="check_WallPosts" src="<%=Page.ResolveUrl("~/Contents/img/check_click.png")%>" alt="" />
                        </li>
                      </ul>
                    </div>
                  </div>
