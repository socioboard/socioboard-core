<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="~/WooReports/FacebookReport.aspx.cs" Inherits="WooSuite.WooReports.FacebookReport" %>
                        ...
                        <div class="rounder shadower pull-left reportcontent" >
                          ...
                          <div class="fb-graph-right">
                            ...
                            <div class="impression-graph-outer">
                                ...
                                <div class="impres-chart"><div id="impress_chart" ></div></div>
                          ...
                          <div class="stories-graph-right">
                                <div class="stories-graph-head">
                                    ...
                                    <div class="stories-graph-right-head">
                                    	<img src="../Contents/img/graph-icon.jpg" alt="" align="absmiddle" />Stories Created <strong><div id="storiescount" runat="server"> </strong><%-- <span><img src="../Contents/img/graph-icon2.jpg" alt="" align="absmiddle" /> by 127.5k Users</span>--%>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                ...
                                <div class="fb-graph">
                                	<%--<div id="stories_combo_chart" style="width: 100%; height: 150px;"></div>--%>
                                     <canvas id="stories_combo_chart" width="100%" height="100">[No canvas support]</canvas>
                                </div>
                          </div>
                            <div class="clear"></div>
                            ...
                            <div class="impression-break-container">
                            	<div class="share-pie-left">
                                    ...
                                    <div class="share-pie-left"><div id="share_pie" style="width:100%; height: 175px;"></div></div>
                                    <div class="clear"></div>
                                </div>
...
<script type="text/javascript" src="../Contents/js/graph-admin-panel.js"></script>
