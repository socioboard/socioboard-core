<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="BusinessSetting.aspx.cs" Inherits="WooSuite.Settings.BusinessSetting" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<title>MoopleSocial-TeamMember-PersonalSetting</title>
        ...
        <div class="ws_tm_mid">                    	
                        <div class="ws_tm_personal_setting">
                           ...
                           <div class="personal_setting_left">
                                ...
                                <div class="ws_ps_user_content">                                	
                                    <div class="personal_details">
                                    	MoopleSocial alerts you & your team members via email on various activities.
                                    </div>
                                    <div class="radio_content">
                              ...
                              <%--  <div class="invite_friends">Facebook Audience Confirmation</div>
                                ...
                                <div class="ws_ps_user_content">                                	
                                    <div class="personal_details">
                                        ...
                                        dedicated album titled MoopleSocial Photos. You are able to rename the MoopleSocial album within Facebook.
                                    </div>
                                    <div class="radio_content">
