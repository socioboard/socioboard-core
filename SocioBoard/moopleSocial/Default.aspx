  ...
  <link rel="shortcut icon" href="Contents/img/favicon.png">  
    ...
    <script type="text/javascript">	
        ...
        $('#popupplans').bPopup({
			...
			$('#woosuite_video_link').click(function()
			{					
				$('#popupdiv').bPopup({
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="container">
			...
			<div class="bg1">
				<div class="logo">
					<a href="#"><img alt="woosuite" src="Contents/img/woosuite_logo.png" height="54" width="142"></a>
				</div>
			...
			<div class="bg2">
				<div class="bg-in">
					<header class="title">
						...
						MoopleSocial takes care of your Social Media like nobody else
					</header>
					...
					<div class="reg-form">                                        
						<fieldset>
							<ul class="form">
							  <li>
									<div class="input">
										<input value="" name="user[email]" id="signinFirstName" onkeypress="return onlyAlphabets(event,this);" onblur="if(this.value == ''){document.getElementById('signinFirstNameError').innerHTML = 'Please Enter FirstName';document.getElementById('signinFirstNameError').style.display ='block';}else{document.getElementById('signinFirstNameError').innerHTML = '';}"
								...
								<li>
								  ...
								  <li>
									<div class="input">
										<input value="" name="user[email]" onkeypress="return onlyAlphabets(event,this);" onblur="if(this.value == ''){document.getElementById('signinLastNameError').innerHTML = 'Please Enter LastName';document.getElementById('signinLastNameError').style.display ='block';}else{document.getElementById('signinLastNameError').innerHTML = '';}"
			...
			<%--	onclick="RegisterDefault();"	--%>			<li id="signupbtn">
					...
					<section class="video">
						<a href="#" id="woosuite_video_link"><img alt="Vid" src="Contents/img/video_run.png" height="299" width="504"></a>            
						<div class="text"></div>
					</section>
				</div>
			</div>
            ...
            <div class="content">
                ...
                <div class="screen">
                    <img alt="1" src="Contents/img/dashborad.png" height="496" width="990" />
                </div>
                <!--screens-->
                ...
                <!--end screens-->
                <header class="title">
				<strong>What people say about MoopleSocial</strong>
	...
	<div class="container">
		...
		<div class="hr"></div>
		Copyright © 2013 MoopleSocial Ltd.
	</div>
	<!--end container-->
</footer>
    <!--end footer-->
