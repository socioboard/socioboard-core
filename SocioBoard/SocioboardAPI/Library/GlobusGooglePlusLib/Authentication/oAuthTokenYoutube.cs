...
namespace GlobusGooglePlusLib.Authentication
{
    public class oAuthTokenYoutube
    {
        ...
        public string GetAutherizationLinkGa(string scope)
        {
            ...
            strAuthUrl += "?scope=" + scope + "&redirect_uri=" + ConfigurationManager.AppSettings["Ytredirect_uri"] + "&response_type=code&client_id=" + ConfigurationManager.AppSettings["YtconsumerKey"] + "&approval_prompt=force&access_type=offline";
            return strAuthUrl;
        }
        ...
        public string WebRequest(GlobusGooglePlusLib.Authentication.oAuthToken.Method method, string url, string postData)
        {
            ...
            if (method == GlobusGooglePlusLib.Authentication.oAuthToken.Method.POST)
            {
        ...
        public string Post_WebRequest(GlobusGooglePlusLib.Authentication.oAuthToken.Method method, string url, string postData, string[] HeaderName, string[] Value)
        {
            HttpWebRequest webRequest = null;
            StreamWriter requestWriter = null;
            string responseData = "";
