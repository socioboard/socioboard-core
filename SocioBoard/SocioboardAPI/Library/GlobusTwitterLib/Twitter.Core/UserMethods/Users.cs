...
namespace GlobusTwitterLib.Twitter.Core.UserMethods
{
    public class Users
    {
       ...
       /// <returns></returns>
        ...
        {
            string RequestUrl = Globals.GetAccountSettingsUrl;
        ...
        {
            string RequestUrl = Globals.GetAccountVerifyCredentialsUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
       ...
       /// <returns></returns>
        ...
        {
            string RequestUrl = Globals.PostAccountSettingsUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
       ...
       /// <returns></returns>
        ...
        {
            string RequestUrl = Globals.PostAccountUpdateDeliveryDeviceUrl;
      ...
      /// <returns></returns>
       ...
       /// <returns></returns>
        ...
        {
            string RequestUrl = Globals.PostAccountUpdateProfileImageUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.GetUserSuggestions;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
            string response = oauth.oAuthWebRequest(oAuthTwitter.Method.GET, RequestUrl, strdic);
            if (!response.StartsWith("["))
                response = "[" + response + "]";
        ...
        {
            string RequestUrl = Globals.GetFollowersIdUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.GetBlocksListUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.GetBlocksIdUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
       ...
       /// <returns></returns>
        public JArray Post_Blocks_Create(oAuthTwitter oAuth, string user_id)
        {
            ...
            string RequestUrl = Globals.PostBlockCreateUrl;
        ...
        {
            string RequestUrl = Globals.PostBlocksDestroyUrl;
        ...
        {
            string RequestUrl = Globals.GetUsersLookUpUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.GetUsersShowUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.GetUsersSearchUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.GetUsersContributeesUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.GetUsersContributorsUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.PostAccountRemoveProfileBannerUrl;
                        SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
     ...
     /// <returns></returns>
        ...
        {
            string RequestUrl = Globals.PostAccountUpdateProfileBannerUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.GetUsersProfileBannerUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
