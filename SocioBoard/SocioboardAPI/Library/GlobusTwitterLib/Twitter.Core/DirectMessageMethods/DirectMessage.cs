...
namespace GlobusTwitterLib.Twitter.Core.DirectMessageMethods
{
    public class DirectMessage
    {
        ...
        public JArray Get_Direct_Messages(oAuthTwitter oAuth,int count)
        {
            ...
            string RequestUrl = Globals.GetDirectMesagesUrl;
        ...
        {
            string RequestUrl = Globals.GetDirectMessagesSentUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
            strdic.Add("count", count.ToString());
            string response = oAuth.oAuthWebRequest(oAuthTwitter.Method.GET, RequestUrl, strdic);
        ...
        {
            string RequestUrl = Globals.GetDirectMessagesShowUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
        ...
        {
            string RequestUrl = Globals.PostDirectMessagesDestroyUrl;
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
            strdic.Add("id", directMessageId);
