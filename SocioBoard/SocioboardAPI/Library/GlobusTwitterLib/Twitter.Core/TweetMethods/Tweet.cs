...
namespace GlobusTwitterLib.Twitter.Core.TweetMethods
{
    public class Tweet
    {
        ...
        public JArray Get_Statuses_RetweetsById(oAuthTwitter oAuth, string UserId)
        {
            ...
            string RequestUrl = Globals.StatusesRetweetByIdUrl + UserId + ".json";
        ...
        {
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
            string RequestUrl = Globals.StatusShowByIdUrl + UserId;
            string response = oAuth.oAuthWebRequest(oAuthTwitter.Method.GET, RequestUrl, strdic);
            if (!response.StartsWith("["))
                response = "[" + response + "]";
            return JArray.Parse(response);
        ...
        {
            string RequestUrl = Globals.PostStatusesRetweetByIdUrl + UserId + ".json";
            SortedDictionary<string, string> strdic = new SortedDictionary<string, string>();
            string response = oAuth.oAuthWebRequest(oAuthTwitter.Method.POST, RequestUrl, strdic);
            if (!response.StartsWith("["))
                response = "[" + response + "]";
