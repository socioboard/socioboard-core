			...
			<div id="sidebar">
             <div class="sidebar-inner" style="width:255px;">
				...
				<div class="sidebar-inner">
                    ...
                    <span>to connected </span>SocialHives<ul id="profile-connect" style="width:270px;">
            	...
            	<div id="contentcontainer1">
                	<div id="content">
						<div class="alert alert-suite">
							...
							<p id="divNews" runat="server">Welcome to SocialHives Your Social Business Partners</p>
