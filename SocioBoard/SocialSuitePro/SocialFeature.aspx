<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/socialsuite.Master" AutoEventWireup="true" CodeBehind="SocialFeature.aspx.cs" Inherits="SocialSuitePro.SocialFeature" %>
                ...
                <div class="welcome-built" id="for-everyone">
                    <div class="features-page">
                        ...
                        <div class="features-page-header">
                        	SocialSuitePro is an advanced easy to use Social Network Software which will engage your visitors with great features such as: 
                        ...
                        <div class="six columns">
                            <div class="features-page-desc">
                                ...
                                by date or by events.<br /><br />You can comment the activity of your friends, like posts, comment and even share them.<br />
